...
import 'package:smartkit/UIScreens/Onbording/src/ExampleCustom.dart';
import 'package:smartkit/UIScreens/Onbording/src/ExampleSwiperInScrollView.dart';
import 'package:smartkit/UIScreens/Onbording/src/config.dart';
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
      ...
      routes: {
        ...
        '/example06': (BuildContext context) => new ScaffoldWidget(child: new ExampleSwiperInScrollView(), title: "ScrollView"),
                          ...
                          children: <Widget>[
                            ...
                            new Expanded(
                              child: new Align(
                                ...
                                child: new DotSwiperPaginationBuilder(color: Colors.black12, activeColor: Colors.black, size: 10.0, activeSize: 20.0).build(context, config),
                              ),
                            )
                          ],
                        ),
        ...
        children: <Widget>[
          ConstrainedBox(
            ...
            child: new CachedNetworkImage(
              imageUrl: "https://smartkit.wrteam.in/smartkit/images/bg.jpeg",
              fit: BoxFit.fill,
            ),
          ),
          new Swiper.children(
            autoplay: false,
            pagination: new SwiperPagination(margin: new EdgeInsets.fromLTRB(0.0, 0.0, 0.0, 30.0), builder: new DotSwiperPaginationBuilder(color: Colors.white30, activeColor: Colors.white, size: 20.0, activeSize: 20.0)),
            children: <Widget>[
              new CachedNetworkImage(
                imageUrl: "https://smartkit.wrteam.in/smartkit/images/1.png",
                fit: BoxFit.contain,
              ),
              new CachedNetworkImage(
                imageUrl: "https://smartkit.wrteam.in/smartkit/images/2.png",
                fit: BoxFit.contain,
              ),
              new CachedNetworkImage(imageUrl: "https://smartkit.wrteam.in/smartkit/images/3.png", fit: BoxFit.contain)
            ],
          )
        ],
      ),
