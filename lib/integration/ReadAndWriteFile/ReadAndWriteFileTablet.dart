...
class ReadAndWriteFileTablet extends StatefulWidget {
  final FileStorageTablet filestorage;

  ReadAndWriteFileTablet({Key key, this.filestorage}) : super(key: key);

  @override
  _ReadAndWriteFileStateTablet createState() => _ReadAndWriteFileStateTablet();
}

class _ReadAndWriteFileStateTablet extends State<ReadAndWriteFileTablet> {
  String files = "";
