...
class ReadAndWriteFileDesktop extends StatefulWidget {
  final FileStorageDesktop filestorage;

  ReadAndWriteFileDesktop({Key key, this.filestorage}) : super(key: key);

  @override
  _ReadAndWriteFileStateDesktop createState() => _ReadAndWriteFileStateDesktop();
}

class _ReadAndWriteFileStateDesktop extends State<ReadAndWriteFileDesktop> {
  String files = "";
