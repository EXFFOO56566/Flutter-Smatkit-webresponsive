...
import 'package:smartkit/integration/animation/searchbaranimation.dart';
...
class _AnimationRouteState extends State<AnimationRoute> {
  List wrNewComponents = [
    ...
    {
      'route': ListviewAnimation(),
      'title': "Listview Animation",
    },
    {
      'route': BouncingButton(),
      'title': "Bouncing Button",
    },
    {
      'route': StaggeredAnimationAnimation(),
      'title': "Staggered Animation",
    },
    {
      'route': LoginCurveAnimation(),
      'title': "LoginCurve Animation",
    },
    {
      'route': Searchanimation(),
