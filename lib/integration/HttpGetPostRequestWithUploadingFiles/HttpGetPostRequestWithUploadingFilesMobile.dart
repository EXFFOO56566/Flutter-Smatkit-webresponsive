...
class HttpGetPostRequestWithUploadingFilesMobile extends StatefulWidget {
  HttpGetPostRequestWithUploadingFilesMobile({Key key, this.title}) : super(key: key);
  final String title;
  @override
  HttpGetPostRequestWithUploadingFilesStateMobile  createState() => new HttpGetPostRequestWithUploadingFilesStateMobile();
}

class HttpGetPostRequestWithUploadingFilesStateMobile extends State< HttpGetPostRequestWithUploadingFilesMobile> {
  final GlobalKey<FormState> key = GlobalKey<FormState>();
  String userimage = '';
  File image,data;
  var isLoading,isslideravailabe,pro;
  TextEditingController editName = new TextEditingController();
  TextEditingController edtiMobile = new TextEditingController();
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: TextFormField(
                                  ...
                                  maxLines: null,
                                  minLines: 1,
                                  controller: edtiMobile,
                                ),
                              ),
                              SizedBox(height:20),
                              GestureDetector(
                                onTap:(){
                                  editProfileData(editName.text,edtiMobile.text);
                                  editName.clear();
                                  edtiMobile.clear();
                                },
                                child: Container(
