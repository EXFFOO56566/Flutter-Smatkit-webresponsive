...
class PaginationTablet extends StatefulWidget {
  PaginationTablet({Key key, this.title}) : super(key: key);
  final String title;

  @override
  PaginationStateTablet createState() => new PaginationStateTablet();
}

class PaginationStateTablet extends State<PaginationTablet> {
