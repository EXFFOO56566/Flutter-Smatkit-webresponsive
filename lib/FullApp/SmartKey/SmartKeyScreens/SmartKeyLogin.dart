...
import 'package:smartkit/FullApp/SmartKey/SmartKeyScreens/SmartkeySingUp.dart';
import 'package:smartkit/FullApp/SmartKey/Widget/SmartKeyBtn.dart';
import 'package:smartkit/SmartkitScreen/Screen/SmartKitHome.dart';

import 'SmartKeyHome.dart';

class SmartKeyLogin extends StatefulWidget {
  SmartKeyLogin({Key key}) : super(key: key);

  @override
  _SmartKeyLoginState createState() => _SmartKeyLoginState();
}

class _SmartKeyLoginState extends State<SmartKeyLogin> with TickerProviderStateMixin {
        ...
        children: <Widget>[
          ...
          CupertinoButton(
            onPressed: () {
              Navigator.push(
                context,
                PageRouteBuilder(pageBuilder: (context, anim1, anim2) => SmartKeySingUp()),
              );
            },
