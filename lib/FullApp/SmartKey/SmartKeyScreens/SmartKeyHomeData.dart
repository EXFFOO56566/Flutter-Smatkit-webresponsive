...
import 'package:smartkit/FullApp/SmartKey/SmartKeyScreens/SmartKeyCategory.dart';
import 'package:smartkit/FullApp/SmartKey/Widget/SmartKeyBtn.dart';
import 'package:smartkit/SmartkitScreen/Screen/SmartKitHome.dart';

import 'SmartKeyBattel.dart';

class SmartKeyHomeDate extends StatefulWidget {
  SmartKeyHomeDate({Key key}) : super(key: key);

  @override
  _SmartKeyHomeDateState createState() => _SmartKeyHomeDateState();
}

class _SmartKeyHomeDateState extends State<SmartKeyHomeDate> with TickerProviderStateMixin {
  double xoffSet = 0;
  double yoffSet = 0;
  double angle = 0;
        ...
        child: SmartKeyBtn(
          ...
          route: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => SmartKeyCategory(),
              ),
            );
          },
        ));
        ...
        child: SmartKeyBtn(
          ...
          route: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => SamrtKeyBattle(),
              ),
            );
          },
        ));
