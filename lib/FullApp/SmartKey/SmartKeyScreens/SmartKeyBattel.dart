...
class SamrtKeyBattle extends StatefulWidget {
  SamrtKeyBattle({Key key}) : super(key: key);

  @override
  _SamrtKeyBattleState createState() => _SamrtKeyBattleState();
}

class _SamrtKeyBattleState extends State<SamrtKeyBattle> {
  @override
