...
class SmartKeyStatistics extends StatefulWidget {
  SmartKeyStatistics({Key key}) : super(key: key);

  @override
  _SmartKeyStatisticsState createState() => _SmartKeyStatisticsState();
}

class _SmartKeyStatisticsState extends State<SmartKeyStatistics> {
