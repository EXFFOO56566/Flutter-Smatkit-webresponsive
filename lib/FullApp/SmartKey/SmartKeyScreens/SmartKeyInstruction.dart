...
class SmartKeyinstruction extends StatefulWidget {
  SmartKeyinstruction({Key key}) : super(key: key);

  @override
  _SmartKeyinstructionState createState() => _SmartKeyinstructionState();
}

class _SmartKeyinstructionState extends State<SmartKeyinstruction> {
  @override
