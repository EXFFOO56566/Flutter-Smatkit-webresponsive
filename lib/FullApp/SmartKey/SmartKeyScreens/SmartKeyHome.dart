...
import 'package:smartkit/FullApp/SmartKey/SmartKeyScreens/SmartKeyHomeData.dart';
import 'package:smartkit/FullApp/SmartKey/SmartKeyScreens/SmartKeyInstruction.dart';
import 'package:smartkit/FullApp/SmartKey/SmartKeyScreens/SmartKeyLeaderboard.dart';
import 'package:smartkit/FullApp/SmartKey/SmartKeyScreens/SmartKeyUserProfile.dart';
...
class _SmartKeyHomeState extends State<SmartKeyHome> {
  int tabIndex = 0;
  List<Widget> body = [SmartKeyHomeDate(), SmartKeyCategory(), SmartKeyLeaderboard(), SmartKeyuserProfile()];
              ...
              Column(
                ...
                children: [
                  ...
                  ListTile(
                    ...
                    onTap: () {
                      Navigator.push(context, PageRouteBuilder(pageBuilder: (context, anim1, anim2) => (SmartKeyNotificationList())));
                    },
                  ),
