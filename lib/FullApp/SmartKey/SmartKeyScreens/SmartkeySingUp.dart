...
class SmartKeySingUp extends StatefulWidget {
  SmartKeySingUp({Key key}) : super(key: key);

  @override
  _SmartKeySingUpState createState() => _SmartKeySingUpState();
}

class _SmartKeySingUpState extends State<SmartKeySingUp> with TickerProviderStateMixin {
  ...
  void _handleOnTabBackButton() {
    Navigator.pushReplacement(
      context,
      PageRouteBuilder(pageBuilder: (context, anim1, anim2) => SmartKeyLogin()),
    );
  }
