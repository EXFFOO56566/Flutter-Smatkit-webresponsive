...
class SmartKeyBookmarkList extends StatefulWidget {
  SmartKeyBookmarkList({Key key}) : super(key: key);

  @override
  _SmartKeyBookmarkListState createState() => _SmartKeyBookmarkListState();
}

class _SmartKeyBookmarkListState extends State<SmartKeyBookmarkList> {
  List bookmarkList = [
