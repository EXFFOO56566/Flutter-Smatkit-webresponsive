...
import 'SmartKeyResult.dart';

class SmartKeyPlay extends StatefulWidget {
  SmartKeyPlay({Key key}) : super(key: key);

  @override
  _SmartKeyPlayState createState() => _SmartKeyPlayState();
}

class _SmartKeyPlayState extends State<SmartKeyPlay> with SingleTickerProviderStateMixin {
