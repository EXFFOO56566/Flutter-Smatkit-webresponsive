...
class SmartKeyStatisticsMobile extends StatefulWidget {
  SmartKeyStatisticsMobile({Key key}) : super(key: key);

  @override
  _SmartKeyStatisticsMobileState createState() => _SmartKeyStatisticsMobileState();
}

class _SmartKeyStatisticsMobileState extends State<SmartKeyStatisticsMobile> {
