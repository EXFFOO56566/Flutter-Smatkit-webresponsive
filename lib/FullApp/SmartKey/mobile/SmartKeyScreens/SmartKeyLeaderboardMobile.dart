...
class SmartKeyLeaderboardMobile extends StatefulWidget {
  SmartKeyLeaderboardMobile({Key key}) : super(key: key);

  @override
  _SmartKeyLeaderboardMobileState createState() => _SmartKeyLeaderboardMobileState();
}

class _SmartKeyLeaderboardMobileState extends State<SmartKeyLeaderboardMobile> with TickerProviderStateMixin {
