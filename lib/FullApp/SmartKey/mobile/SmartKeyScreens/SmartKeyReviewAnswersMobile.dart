...
class SmartKeyReviewAnswereMobile extends StatefulWidget {
  SmartKeyReviewAnswereMobile({Key key}) : super(key: key);

  @override
  _SmartKeyReviewAnswereMobileState createState() => _SmartKeyReviewAnswereMobileState();
}

class _SmartKeyReviewAnswereMobileState extends State<SmartKeyReviewAnswereMobile> {
