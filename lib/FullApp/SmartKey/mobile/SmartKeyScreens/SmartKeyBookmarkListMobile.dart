...
class SmartKeyBookmarkListMobile extends StatefulWidget {
  SmartKeyBookmarkListMobile({Key key}) : super(key: key);

  @override
  _SmartKeyBookmarkListMobileState createState() => _SmartKeyBookmarkListMobileState();
}

class _SmartKeyBookmarkListMobileState extends State<SmartKeyBookmarkListMobile> {
  List bookmarkList = [
