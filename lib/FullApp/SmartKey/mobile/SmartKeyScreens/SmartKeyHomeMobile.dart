...
import 'package:smartkit/FullApp/SmartKey/mobile/SmartKeyScreens/SmartKeyHomeDataMobile.dart';
import 'package:smartkit/FullApp/SmartKey/mobile/SmartKeyScreens/SmartKeyInstructionMobile.dart';
import 'package:smartkit/FullApp/SmartKey/mobile/SmartKeyScreens/SmartKeyLeaderboardMobile.dart';
import 'package:smartkit/FullApp/SmartKey/mobile/SmartKeyScreens/SmartKeyUserProfileMobile.dart';
...
class _SmartKeyHomeMobileState extends State<SmartKeyHomeMobile> {
  int tabIndex = 0;
  List<Widget> body = [SmartKeyHomeDateMobile(), SmartKeyCategoryMobile(), SmartKeyLeaderboardMobile(), SmartKeyuserProfileMobile()];
              ...
              Column(
                ...
                children: [
                  ...
                  ListTile(
                    ...
                    onTap: () {
                      Navigator.push(context, PageRouteBuilder(pageBuilder: (context, anim1, anim2) => (SmartKeyNotificationListMobile())));
                    },
                  ),
