...
class _SmartKeySingUpMobileState extends State<SmartKeySingUpMobile> with TickerProviderStateMixin {
  ...
  void _handleOnTabBackButton() {
    Navigator.pushReplacement(
      context,
      PageRouteBuilder(pageBuilder: (context, anim1, anim2) => SmartKeyLoginMobile()),
    );
  }
