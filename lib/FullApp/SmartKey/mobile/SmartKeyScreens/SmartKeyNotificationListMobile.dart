...
class SmartKeyNotificationListMobile extends StatefulWidget {
  SmartKeyNotificationListMobile({Key key}) : super(key: key);

  @override
  _SmartKeyNotificationListMobileState createState() => _SmartKeyNotificationListMobileState();
}

class _SmartKeyNotificationListMobileState extends State<SmartKeyNotificationListMobile> {
  List notifiList = [
