...
import 'SmartKeyResultMobile.dart';

class SmartKeyPlayMobile extends StatefulWidget {
  SmartKeyPlayMobile({Key key}) : super(key: key);

  @override
  _SmartKeyPlayMobileState createState() => _SmartKeyPlayMobileState();
}

class _SmartKeyPlayMobileState extends State<SmartKeyPlayMobile> with SingleTickerProviderStateMixin {
              ...
              child: InkWell(
                  ...
                  onTap: () {
                    Navigator.pushReplacement(
                      context,
                      MaterialPageRoute(
                        builder: (context) => SmartKeyResultMobile(),
                      ),
                    );
                  }),
              //elevation: 4,
