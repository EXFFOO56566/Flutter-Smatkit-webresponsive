...
class SmartKeyInviteFriendMobile extends StatefulWidget {
  SmartKeyInviteFriendMobile({Key key}) : super(key: key);

  @override
  _SmartKeyInviteFriendMobileState createState() => _SmartKeyInviteFriendMobileState();
}

class _SmartKeyInviteFriendMobileState extends State<SmartKeyInviteFriendMobile> {
