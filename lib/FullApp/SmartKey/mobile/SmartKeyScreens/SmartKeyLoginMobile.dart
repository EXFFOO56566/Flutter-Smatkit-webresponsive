...
class _SmartKeyLoginMobileState extends State<SmartKeyLoginMobile> with TickerProviderStateMixin {
        ...
        children: <Widget>[
          ...
          CupertinoButton(
            onPressed: () {
              Navigator.push(
                context,
                PageRouteBuilder(pageBuilder: (context, anim1, anim2) => SmartKeySingUpMobile()),
              );
            },
