...
import 'SmartKeyReviewAnswersMobile.dart';

class SmartKeyResultMobile extends StatefulWidget {
  SmartKeyResultMobile({Key key}) : super(key: key);

  @override
  _SmartKeyResultMobileState createState() => _SmartKeyResultMobileState();
}

class _SmartKeyResultMobileState extends State<SmartKeyResultMobile> {
            ...
            child: SmartKeyBtn(
              ...
              route: () {
                Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(
                    builder: (context) => SmartKeyReviewAnswereMobile(),
                  ),
                );
              },
            ),
