...
class SmartKeyBookmarkListTablet extends StatefulWidget {
  SmartKeyBookmarkListTablet({Key key}) : super(key: key);

  @override
  _SmartKeyBookmarkListTabletState createState() => _SmartKeyBookmarkListTabletState();
}

class _SmartKeyBookmarkListTabletState extends State<SmartKeyBookmarkListTablet> {
  List bookmarkList = [
