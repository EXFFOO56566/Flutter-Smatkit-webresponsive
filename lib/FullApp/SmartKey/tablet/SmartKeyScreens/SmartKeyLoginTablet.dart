...
import 'package:smartkit/FullApp/SmartKey/tablet/SmartKeyScreens/SmartkeySingUpTablet.dart';
import 'package:smartkit/FullApp/SmartKey/Widget/SmartKeyBtn.dart';
import 'package:smartkit/SmartkitScreen/Screen/SmartKitHome.dart';

import 'SmartKeyHomeTablet.dart';

class SmartKeyLoginTablet extends StatefulWidget {
  SmartKeyLoginTablet({Key key}) : super(key: key);

  @override
  _SmartKeyLoginTabletState createState() => _SmartKeyLoginTabletState();
}

class _SmartKeyLoginTabletState extends State<SmartKeyLoginTablet> with TickerProviderStateMixin {
        ...
        children: <Widget>[
          ...
          CupertinoButton(
            onPressed: () {
              Navigator.push(
                context,
                PageRouteBuilder(pageBuilder: (context, anim1, anim2) => SmartKeySingUpTablet()),
              );
            },
