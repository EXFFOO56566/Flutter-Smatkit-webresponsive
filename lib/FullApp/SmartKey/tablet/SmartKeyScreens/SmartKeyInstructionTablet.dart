...
import 'package:smartkit/FullApp/SmartKey/tablet/SmartKeyScreens/SmartKeyCategoryTablet.dart';

class SmartKeyinstructionTablet extends StatefulWidget {
  SmartKeyinstructionTablet({Key key}) : super(key: key);

  @override
  _SmartKeyinstructionTabletState createState() => _SmartKeyinstructionTabletState();
}

class _SmartKeyinstructionTabletState extends State<SmartKeyinstructionTablet> {
  @override
