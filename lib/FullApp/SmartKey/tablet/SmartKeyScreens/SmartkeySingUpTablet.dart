...
class SmartKeySingUpTablet extends StatefulWidget {
  SmartKeySingUpTablet({Key key}) : super(key: key);

  @override
  _SmartKeySingUpTabletState createState() => _SmartKeySingUpTabletState();
}

class _SmartKeySingUpTabletState extends State<SmartKeySingUpTablet>
  ...
  void _handleOnTabBackButton() {
    Navigator.pushReplacement(
      context,
      PageRouteBuilder(
          pageBuilder: (context, anim1, anim2) => SmartKeyLoginTablet()),
    );
  }
    ...
    return Form(
        ...
        child: Stack(
          children: <Widget>[
            showBackground(),
            Center(
              child: SizedBox(width: 700, height: 700,
                child: SafeArea(
                  child: Column(
