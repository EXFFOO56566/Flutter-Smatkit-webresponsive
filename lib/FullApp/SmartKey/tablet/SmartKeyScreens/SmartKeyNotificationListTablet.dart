...
class SmartKeyNotificationListTablet extends StatefulWidget {
  SmartKeyNotificationListTablet({Key key}) : super(key: key);

  @override
  _SmartKeyNotificationListTabletState createState() => _SmartKeyNotificationListTabletState();
}

class _SmartKeyNotificationListTabletState extends State<SmartKeyNotificationListTablet> {
  List notifiList = [
