...
import 'package:smartkit/FullApp/SmartKey/tablet/SmartKeyScreens/SmartKeyLevelTablet.dart';

class SmartKeySubCategoryTablet extends StatefulWidget {
  SmartKeySubCategoryTablet({Key key}) : super(key: key);

  @override
  _SmartKeySubCategoryTabletState createState() => _SmartKeySubCategoryTabletState();
}
