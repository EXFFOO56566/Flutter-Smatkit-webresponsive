...
class SmartKeyInviteFriendTablet extends StatefulWidget {
  SmartKeyInviteFriendTablet({Key key}) : super(key: key);

  @override
  _SmartKeyInviteFriendTabletState createState() => _SmartKeyInviteFriendTabletState();
}

class _SmartKeyInviteFriendTabletState extends State<SmartKeyInviteFriendTablet> {
