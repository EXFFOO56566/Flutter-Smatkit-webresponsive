...
class SmartKeyLeaderboardTablet extends StatefulWidget {
  SmartKeyLeaderboardTablet({Key key}) : super(key: key);

  @override
  _SmartKeyLeaderboardTabletState createState() => _SmartKeyLeaderboardTabletState();
}

class _SmartKeyLeaderboardTabletState extends State<SmartKeyLeaderboardTablet> with TickerProviderStateMixin {
  ...
  Widget rankLayout() {
    return Stack(
      children: <Widget>[
        ...
        Container(
          margin: EdgeInsets.only(top: useMobileLayout ? 200 : 200),
          height: 3,
        ...
        Container(
            margin: EdgeInsets.only(top: useMobileLayout ? 215 : 215),
            decoration: BoxDecoration(
                // Box decoration takes a gradient
                color: Colors.white
                // gradient: LinearGradient(
