...
class SmartKeyReviewAnswereTablet extends StatefulWidget {
  SmartKeyReviewAnswereTablet({Key key}) : super(key: key);

  @override
  _SmartKeyReviewAnswereTabletState createState() => _SmartKeyReviewAnswereTabletState();
}

class _SmartKeyReviewAnswereTabletState extends State<SmartKeyReviewAnswereTablet> {
