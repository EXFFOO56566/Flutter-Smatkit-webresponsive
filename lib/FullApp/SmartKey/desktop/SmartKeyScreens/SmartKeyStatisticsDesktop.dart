...
class SmartKeyStatisticsDesktop extends StatefulWidget {
  SmartKeyStatisticsDesktop({Key key}) : super(key: key);

  @override
  _SmartKeyStatisticsDesktopState createState() => _SmartKeyStatisticsDesktopState();
}

class _SmartKeyStatisticsDesktopState extends State<SmartKeyStatisticsDesktop> {
