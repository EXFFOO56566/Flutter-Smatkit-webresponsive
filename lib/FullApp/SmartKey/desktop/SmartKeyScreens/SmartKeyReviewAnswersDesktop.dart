...
class SmartKeyReviewAnswereDesktop extends StatefulWidget {
  SmartKeyReviewAnswereDesktop({Key key}) : super(key: key);

  @override
  _SmartKeyReviewAnswereDesktopState createState() =>
      _SmartKeyReviewAnswereDesktopState();
}

class _SmartKeyReviewAnswereDesktopState
    extends State<SmartKeyReviewAnswereDesktop> {
