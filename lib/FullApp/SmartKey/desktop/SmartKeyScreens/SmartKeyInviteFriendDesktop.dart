...
class SmartKeyInviteFriendDesktop extends StatefulWidget {
  SmartKeyInviteFriendDesktop({Key key}) : super(key: key);

  @override
  _SmartKeyInviteFriendDesktopState createState() => _SmartKeyInviteFriendDesktopState();
}

class _SmartKeyInviteFriendDesktopState extends State<SmartKeyInviteFriendDesktop> {
