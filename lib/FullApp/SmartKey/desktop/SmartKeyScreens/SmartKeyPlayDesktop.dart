...
import 'SmartKeyResultDesktop.dart';

class SmartKeyPlayDesktop extends StatefulWidget {
  SmartKeyPlayDesktop({Key key}) : super(key: key);

  @override
  _SmartKeyPlayDesktopState createState() => _SmartKeyPlayDesktopState();
}

class _SmartKeyPlayDesktopState extends State<SmartKeyPlayDesktop> with SingleTickerProviderStateMixin {
  ...
  Widget getQuestion() {
    return Row(
      ...
      children: <Widget>[rightProgress(), Expanded(child: questionLayout()), wrongProgress()],
    );
  }
            ...
            child: InkWell(
                ...
                onTap: () {
                  Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                      builder: (context) => SmartKeyResultDesktop(),
                    ),
                  );
                }),
            //elevation: 4,
