...
class SmartKeyNotificationListDesktop extends StatefulWidget {
  SmartKeyNotificationListDesktop({Key key}) : super(key: key);

  @override
  _SmartKeyNotificationListDesktopState createState() => _SmartKeyNotificationListDesktopState();
}

class _SmartKeyNotificationListDesktopState extends State<SmartKeyNotificationListDesktop> {
  List notifiList = [
