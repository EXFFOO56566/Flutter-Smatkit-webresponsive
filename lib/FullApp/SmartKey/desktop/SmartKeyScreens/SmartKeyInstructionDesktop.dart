...
class SmartKeyinstructionDesktop extends StatefulWidget {
  SmartKeyinstructionDesktop({Key key}) : super(key: key);

  @override
  _SmartKeyinstructionDesktopState createState() => _SmartKeyinstructionDesktopState();
}

class _SmartKeyinstructionDesktopState extends State<SmartKeyinstructionDesktop> {
  @override
