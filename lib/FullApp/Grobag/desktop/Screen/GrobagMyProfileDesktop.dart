...
import 'package:smartkit/FullApp/Grobag/desktop/Screen/GrobagMyOrderDesktop.dart';

class GrobagMyProfileDesktop extends StatefulWidget {
  @override
  _GrobagMyProfileDesktopState createState() => _GrobagMyProfileDesktopState();
}

class _GrobagMyProfileDesktopState extends State<GrobagMyProfileDesktop> {
  ...
  _myOrder() {
    return Container(
      ...
      child: ListTile(
        ...
        onTap: () {
          Navigator.push(context, MaterialPageRoute(builder: (context) => GrobagMyOrderDesktop()));
        },
      ),
    );
  }
