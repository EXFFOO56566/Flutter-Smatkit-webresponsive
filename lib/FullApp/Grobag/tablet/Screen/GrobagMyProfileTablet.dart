...
import 'package:smartkit/FullApp/Grobag/tablet/Screen/GrobagMyOrderTablet.dart';

class GrobagMyProfileTablet extends StatefulWidget {
  @override
  _GrobagMyProfileTabletState createState() => _GrobagMyProfileTabletState();
}

class _GrobagMyProfileTabletState extends State<GrobagMyProfileTablet> {
  ...
  _myOrder() {
    return Container(
      ...
      child: ListTile(
        ...
        onTap: () {
          Navigator.push(context, MaterialPageRoute(builder: (context) => GrobagMyOrderTablet()));
        },
      ),
    );
  }
