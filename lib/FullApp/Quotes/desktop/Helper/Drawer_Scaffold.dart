...
class DrawerScaffold extends StatefulWidget {
  ...
  final FancyBottomNavigation bottomNavigationBar;
...
class _DrawerScaffoldState extends State<DrawerScaffold> with TickerProviderStateMixin {
  ...
  Widget createAppBar() {
    ...
    if (widget.appBar == null)
      return AppBar(
        backgroundColor: widget.contentView.appBarColor == null ? Colors.transparent : widget.contentView.appBarColor,
        elevation: 0.0,
  ...
  createContentDisplay() {
    if (selectedItemId != widget.menuView.selectedItemId || body == null) body = widget.contentView.contentBuilder(context);
      ...
      child: Container(
        child: GestureDetector(
          ...
          onHorizontalDragStart: (details) {
            ...
            if (menuController.isOpen() && details.globalPosition.dx < maxSlideAmount + 60) {
...
class Screen {
  ...
  Screen({this.title, this.background, this.contentBuilder, this.color, this.appBarColor});
}
