...
class QuotesSingleAuthorDesktop extends StatefulWidget {
  final String id, name, image;
  QuotesSingleAuthorDesktop({Key key, this.name, this.image, this.id}) : super(key: key);

  @override
  _QuotesSingleAuthorStateDesktop createState() => _QuotesSingleAuthorStateDesktop();
}

class _QuotesSingleAuthorStateDesktop extends State<QuotesSingleAuthorDesktop> {
    ...
    return Hero(
        ...
        child: Container(
          ...
          child: Stack(alignment: Alignment.bottomLeft, children: <Widget>[
            CachedNetworkImage(imageUrl: "https://smartkit.wrteam.in/smartkit/quotes/curve.png", width: double.maxFinite, height: double.maxFinite, fit: BoxFit.fill),
          ]),
        ));
  }
