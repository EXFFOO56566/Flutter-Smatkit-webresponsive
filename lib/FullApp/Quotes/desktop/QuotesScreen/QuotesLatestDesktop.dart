...
class QuotesLatestDesktop extends StatefulWidget {
  QuotesLatestDesktop({Key key}) : super(key: key);

  @override
  _QuotesLatestStateDesktop createState() => _QuotesLatestStateDesktop();
}

class _QuotesLatestStateDesktop extends State<QuotesLatestDesktop> {
