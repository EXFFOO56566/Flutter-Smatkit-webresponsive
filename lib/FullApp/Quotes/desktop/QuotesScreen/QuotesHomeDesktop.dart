...
import 'package:smartkit/FullApp/Quotes/desktop/Helper/Drawer_Scaffold.dart';
import 'package:smartkit/FullApp/Quotes/desktop/Helper/menu_screen.dart';
import 'package:smartkit/FullApp/Quotes/QuotesMain.dart';
import 'package:smartkit/FullApp/Quotes/desktop/QuotesScreen/QuotesAuthorDesktop.dart';
import 'package:smartkit/FullApp/Quotes/desktop/QuotesScreen/QuotesCategoryDesktop.dart';
import 'package:smartkit/FullApp/Quotes/desktop/QuotesScreen/QuotesLatestDesktop.dart';
...
class QuotesHomeDesktop extends StatefulWidget {
  QuotesHomeDesktop({Key key}) : super(key: key);

  @override
  _QuotesHomeStateDesktop createState() => _QuotesHomeStateDesktop();
}

class _QuotesHomeStateDesktop extends State<QuotesHomeDesktop> with SingleTickerProviderStateMixin {
  ...
  final List<Widget> _children = [
    ...
    QuotesCategoryDesktop(
      key: PageStorageKey('Page2'),
    ),
    QuotesAuthorDesktop(key: PageStorageKey('Page3'))
  ];
      ...
      (url) {
        return Container(
          ...
          child: ClipRRect(
            ...
            child: CachedNetworkImage(imageUrl: url, fit: BoxFit.fill, width: double.infinity),
          ),
        );
      },
    ).toList(),
