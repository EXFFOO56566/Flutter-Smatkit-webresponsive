...
import 'package:smartkit/FullApp/Quotes/desktop/Helper/component.dart';
...
class QuotePageDesktop extends StatefulWidget {
  QuotePageDesktop({
    Key key,
  }) : super(key: key);

  @override
  _QuotePageStateDesktop createState() => _QuotePageStateDesktop();
}

class _QuotePageStateDesktop extends State<QuotePageDesktop> {
  List quoteList = [
