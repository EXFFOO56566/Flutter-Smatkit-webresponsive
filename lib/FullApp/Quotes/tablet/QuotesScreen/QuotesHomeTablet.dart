...
import 'package:smartkit/FullApp/Quotes/tablet/Helper/Drawer_Scaffold.dart';
import 'package:smartkit/FullApp/Quotes/tablet/Helper/menu_screen.dart';
import 'package:smartkit/FullApp/Quotes/QuotesMain.dart';
import 'package:smartkit/FullApp/Quotes/tablet/QuotesScreen/QuotesAuthorTablet.dart';
import 'package:smartkit/FullApp/Quotes/tablet/QuotesScreen/QuotesCategoryTablet.dart';
import 'package:smartkit/FullApp/Quotes/tablet/QuotesScreen/QuotesLatestTablet.dart';
...
class QuotesHomeTablet extends StatefulWidget {
  QuotesHomeTablet({Key key}) : super(key: key);

  @override
  _QuotesHomeStateTablet createState() => _QuotesHomeStateTablet();
}

class _QuotesHomeStateTablet extends State<QuotesHomeTablet> with SingleTickerProviderStateMixin {
  ...
  final List<Widget> _children = [
    ...
    QuotesCategoryTablet(
      key: PageStorageKey('Page2'),
    ),
    QuotesAuthorTablet(key: PageStorageKey('Page3'))
  ];
