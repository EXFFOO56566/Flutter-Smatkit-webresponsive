...
class QuotesCategoryTablet extends StatefulWidget {
  QuotesCategoryTablet({Key key}) : super(key: key);

  @override
  _QuotesCategoryStateTablet createState() => _QuotesCategoryStateTablet();
}

class _QuotesCategoryStateTablet extends State<QuotesCategoryTablet> {
  List listCat = [
