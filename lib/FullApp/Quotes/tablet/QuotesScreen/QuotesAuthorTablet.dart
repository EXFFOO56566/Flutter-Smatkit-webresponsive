...
import 'package:smartkit/FullApp/Quotes/tablet/QuotesScreen/QuotesSingleAuthorTablet.dart';

class QuotesAuthorTablet extends StatefulWidget {
  QuotesAuthorTablet({Key key}) : super(key: key);

  @override
  _QuotesAuthorStateTablet createState() => _QuotesAuthorStateTablet();
}

class _QuotesAuthorStateTablet extends State<QuotesAuthorTablet> {
  List listCat = [
    {
        ...
        return new GestureDetector(
          ...
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => QuotesSingleAuthorTablet(
                  id: tag,
