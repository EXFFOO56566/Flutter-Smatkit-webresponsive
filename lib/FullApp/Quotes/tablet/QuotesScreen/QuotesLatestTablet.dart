...
class QuotesLatestTablet extends StatefulWidget {
  QuotesLatestTablet({Key key}) : super(key: key);

  @override
  _QuotesLatestStateTablet createState() => _QuotesLatestStateTablet();
}

class _QuotesLatestStateTablet extends State<QuotesLatestTablet> {
