...
import 'package:smartkit/FullApp/Quotes/tablet/Helper/component.dart';
...
class QuotePageTablet extends StatefulWidget {
  QuotePageTablet({
    Key key,
  }) : super(key: key);

  @override
  _QuotePageStateTablet createState() => _QuotePageStateTablet();
}

class _QuotePageStateTablet extends State<QuotePageTablet> {
  List quoteList = [
