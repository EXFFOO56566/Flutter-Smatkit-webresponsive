...
import 'package:smartkit/FullApp/Quotes/tablet/QuotesScreen/QuotePageTablet.dart';

class QuotesSingleAuthorTablet extends StatefulWidget {
  final String id, name, image;
  QuotesSingleAuthorTablet({Key key, this.name, this.image, this.id}) : super(key: key);

  @override
  _QuotesSingleAuthorStateTablet createState() => _QuotesSingleAuthorStateTablet();
}

class _QuotesSingleAuthorStateTablet extends State<QuotesSingleAuthorTablet> {
        ...
        child: new GestureDetector(
          ...
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => QuotePageTablet(),
              ),
            );
          },
        ));
