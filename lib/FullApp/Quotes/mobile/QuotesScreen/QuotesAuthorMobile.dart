...
import 'package:smartkit/FullApp/Quotes/mobile/QuotesScreen/QuotesSingleAuthorMobile.dart';

class QuotesAuthorMobile extends StatefulWidget {
  QuotesAuthorMobile({Key key}) : super(key: key);

  @override
  _QuotesAuthorStateMobile createState() => _QuotesAuthorStateMobile();
}

class _QuotesAuthorStateMobile extends State<QuotesAuthorMobile> {
  List listCat = [
    {
        ...
        return new GestureDetector(
          ...
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => QuotesSingleAuthorMobile(
                  id: tag,
