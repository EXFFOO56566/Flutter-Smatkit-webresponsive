...
class QuotesSingleAuthorMobile extends StatefulWidget {
  final String id, name, image;
  QuotesSingleAuthorMobile({Key key, this.name, this.image, this.id}) : super(key: key);

  @override
  _QuotesSingleAuthorStateMobile createState() => _QuotesSingleAuthorStateMobile();
}

class _QuotesSingleAuthorStateMobile extends State<QuotesSingleAuthorMobile> {
