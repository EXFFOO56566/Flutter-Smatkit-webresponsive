...
import 'package:smartkit/FullApp/Quotes/mobile/Helper/Drawer_Scaffold.dart';
import 'package:smartkit/FullApp/Quotes/mobile/Helper/menu_screen.dart';
import 'package:smartkit/FullApp/Quotes/QuotesMain.dart';
import 'package:smartkit/FullApp/Quotes/mobile/QuotesScreen/QuotesAuthorMobile.dart';
import 'package:smartkit/FullApp/Quotes/mobile/QuotesScreen/QuotesCategoryMobile.dart';
import 'package:smartkit/FullApp/Quotes/mobile/QuotesScreen/QuotesLatestMobile.dart';
...
class QuotesHomeMobile extends StatefulWidget {
  QuotesHomeMobile({Key key}) : super(key: key);

  @override
  _QuotesHomeStateMobile createState() => _QuotesHomeStateMobile();
}

class _QuotesHomeStateMobile extends State<QuotesHomeMobile> with SingleTickerProviderStateMixin {
  ...
  final List<Widget> _children = [
    ...
    QuotesCategoryMobile(
      key: PageStorageKey('Page2'),
    ),
    QuotesAuthorMobile(key: PageStorageKey('Page3'))
  ];
