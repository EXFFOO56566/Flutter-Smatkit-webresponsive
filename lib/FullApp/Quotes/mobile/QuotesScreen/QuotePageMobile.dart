...
import 'package:smartkit/FullApp/Quotes/mobile/Helper/component.dart';
...
class QuotePageMobile extends StatefulWidget {
  QuotePageMobile({
    Key key,
  }) : super(key: key);

  @override
  _QuotePageStateMobile createState() => _QuotePageStateMobile();
}

class _QuotePageStateMobile extends State<QuotePageMobile> {
  List quoteList = [
