...
class QuotesLatestMobile extends StatefulWidget {
  QuotesLatestMobile({Key key}) : super(key: key);

  @override
  _QuotesLatestStateMobile createState() => _QuotesLatestStateMobile();
}

class _QuotesLatestStateMobile extends State<QuotesLatestMobile> {
