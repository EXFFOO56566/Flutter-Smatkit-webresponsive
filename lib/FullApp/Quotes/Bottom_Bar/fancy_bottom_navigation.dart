...
import 'package:smartkit/FullApp/Quotes/Bottom_Bar/tab_item.dart';
import 'package:smartkit/FullApp/Quotes/Bottom_Bar/half_clipper.dart';
import 'package:smartkit/FullApp/Quotes/Bottom_Bar/half_painter.dart';
...
class FancyBottomNavigation extends StatefulWidget {
  FancyBottomNavigation({@required this.tabs, @required this.onTabChangedListener, this.key, this.initialSelection = 0, this.circleColor, this.activeIconColor, this.inactiveIconColor, this.textColor, this.barBackgroundColor})
                        ...
                        SizedBox(
                          ...
                          child: ClipRect(
                              ...
                              child: Container(
                                child: Center(
                                  child: Container(
                                      width: CIRCLE_SIZE + CIRCLE_OUTLINE, height: CIRCLE_SIZE + CIRCLE_OUTLINE, decoration: BoxDecoration(color: Colors.white, shape: BoxShape.circle, boxShadow: [BoxShadow(color: Colors.black12, blurRadius: 8)])),
                                ),
                              )),
                        ),
                        SizedBox(
