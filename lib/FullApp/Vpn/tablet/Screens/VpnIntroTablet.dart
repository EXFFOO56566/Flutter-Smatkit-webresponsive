...
class VpnIntroTablet extends StatefulWidget {
  VpnIntroTablet({Key key}) : super(key: key);

  @override
  _VpnIntroStateTablet createState() => _VpnIntroStateTablet();
}

class _VpnIntroStateTablet extends State<VpnIntroTablet> {
