...
import 'package:smartkit/FullApp/Vpn/tablet/Screens/VpnHomeTablet.dart';
...
class VpnSubscriptionDetailTablet extends StatefulWidget {
  ...
  @override
  _VpnSubscriptionDetailStateTablet createState() => _VpnSubscriptionDetailStateTablet();
}

class _VpnSubscriptionDetailStateTablet extends State<VpnSubscriptionDetailTablet> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Center(
          child: SizedBox(width:500,height:400,
            child: Column(
              children: [
                Expanded(
                  child: ListView(
                ...
                GestureDetector(
                  onTap: () {
                    ...
                    Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => VpnHomeTablet()));
                  },
                  child: Container(
