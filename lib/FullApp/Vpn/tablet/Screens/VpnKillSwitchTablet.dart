...
class VpnKillSwitchTablet extends StatefulWidget {
  VpnKillSwitchTablet({Key key}) : super(key: key);

  @override
  _VpnKillSwitchStateTablet createState() => _VpnKillSwitchStateTablet();
}

class _VpnKillSwitchStateTablet extends State<VpnKillSwitchTablet> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: vpnSetAppbar("Kill Switch"),
      body: Center(
        child: SizedBox(width:600,height:300,
          child: ListView(
