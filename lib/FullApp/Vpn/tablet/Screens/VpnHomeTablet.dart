...
class _VpnHomeStateTablet extends State<VpnHomeTablet> with TickerProviderStateMixin {
        ...
        body: SafeArea(
          child: Column(
            ...
            children: [
              GestureDetector(
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => VpnSubscriptionDetailTablet()));
                },
                child: Container(
...
//                 }),
  ...
  void _changeLocationClick(bool isfinish) async {
    ...
    await Navigator.push(context, MaterialPageRoute(builder: (context) => VpnSelectVpnTablet()));
  }
    ...
    return ListView(
      ...
      children: <Widget>[
        ...
        ListTile(
          ...
          onTap: () {
            Navigator.of(context).pop();
            Navigator.push(context, MaterialPageRoute(builder: (context) => VpnKillSwitchTablet()));
          },
        ),
        Padding(
        ...
        ListTile(
          ...
          onTap: () {
            Navigator.of(context).pop();
            Navigator.push(context, MaterialPageRoute(builder: (context) => AboutScreenTablet()));
          },
        ),
        ListTile(
          //dense: true,
        ...
        ListTile(
          ...
          onTap: () {
            Navigator.of(context).pop();
            Navigator.of(context).push(MaterialPageRoute(builder: (context) => VpnSharePageTablet()));
          },
        ),
      ],
    );
