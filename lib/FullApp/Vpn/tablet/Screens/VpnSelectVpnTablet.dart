...
class VpnSelectVpnTablet extends StatefulWidget {
  VpnSelectVpnTablet({Key key}) : super(key: key);

  @override
  _VpnSelectVpnStateTablet createState() => _VpnSelectVpnStateTablet();
}

class _VpnSelectVpnStateTablet extends State<VpnSelectVpnTablet> with TickerProviderStateMixin {
  int page = 0;
