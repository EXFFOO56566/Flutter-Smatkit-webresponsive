...
class VpnIntro extends StatefulWidget {
  VpnIntro({Key key}) : super(key: key);

  @override
  _VpnIntroState createState() => _VpnIntroState();
}

class _VpnIntroState extends State<VpnIntro> {
