...
class VpnSelectVpnDesktop extends StatefulWidget {
  VpnSelectVpnDesktop({Key key}) : super(key: key);

  @override
  _VpnSelectVpnStateDesktop createState() => _VpnSelectVpnStateDesktop();
}

class _VpnSelectVpnStateDesktop extends State<VpnSelectVpnDesktop> with TickerProviderStateMixin {
  int page = 0;
