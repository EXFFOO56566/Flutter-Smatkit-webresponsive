...
class VpnKillSwitchDesktop extends StatefulWidget {
  VpnKillSwitchDesktop({Key key}) : super(key: key);

  @override
  _VpnKillSwitchStateDesktop createState() => _VpnKillSwitchStateDesktop();
}

class _VpnKillSwitchStateDesktop extends State<VpnKillSwitchDesktop> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: vpnSetAppbar("Kill Switch"),
      body: Center(
        child: SizedBox(height: 400,width: 600,
          child: ListView(
