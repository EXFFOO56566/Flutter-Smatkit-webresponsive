...
import 'package:smartkit/FullApp/Vpn/desktop/Screens/VpnKillSwitchDesktop.dart';
...
import 'package:smartkit/FullApp/Vpn/desktop/Screens/VpnsharePageDesktop.dart';
import 'package:smartkit/FullApp/Vpn/desktop/Screens/aboutScreenDesktop.dart';
import 'package:smartkit/FullApp/Vpn/widget/customDivider.dart';
import 'package:smartkit/SmartkitScreen/Screen/SmartKitHome.dart';

class VpnHomeDesktop extends StatefulWidget {
  VpnHomeDesktop({Key key}) : super(key: key);

  @override
  _VpnHomeStateDesktop createState() => _VpnHomeStateDesktop();
}

class _VpnHomeStateDesktop extends State<VpnHomeDesktop> with TickerProviderStateMixin {
            ...
            child: SizedBox(
              ...
              child: Column(
                ...
                children: [
                  GestureDetector(
                    onTap: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => VpnSubscriptionDetailDesktop()));
                    },
                    child: Container(
...
//                 }),
  ...
  void _changeLocationClick(bool isfinish) async {
    ...
    await Navigator.push(context, MaterialPageRoute(builder: (context) => VpnSelectVpnDesktop()));
  }
      ...
      children: <Widget>[
        ...
        ListTile(
          ...
          onTap: () {
            ...
            Navigator.push(context, MaterialPageRoute(builder: (context) => VpnSelectVpnDesktop()));
          },
        ),
        ListTile(
          ...
          onTap: () {
            Navigator.of(context).pop();
            Navigator.push(context, MaterialPageRoute(builder: (context) => VpnKillSwitchDesktop()));
          },
        ),
        Padding(
        ...
        ListTile(
          ...
          onTap: () {
            Navigator.of(context).pop();
            Navigator.push(context, MaterialPageRoute(builder: (context) => AboutScreenDesktop()));
          },
        ),
        ListTile(
          //dense: true,
        ...
        ListTile(
          ...
          onTap: () {
            Navigator.of(context).pop();
            Navigator.of(context).push(MaterialPageRoute(builder: (context) => VpnSharePageDesktop()));
          },
        ),
      ],
    );
