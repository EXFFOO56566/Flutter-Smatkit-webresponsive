...
class VpnSelectVpnMobile extends StatefulWidget {
  VpnSelectVpnMobile({Key key}) : super(key: key);

  @override
  _VpnSelectVpnStateMobile createState() => _VpnSelectVpnStateMobile();
}

class _VpnSelectVpnStateMobile extends State<VpnSelectVpnMobile> with TickerProviderStateMixin {
  int page = 0;
