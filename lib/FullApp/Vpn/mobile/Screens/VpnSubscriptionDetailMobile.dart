...
import 'package:smartkit/FullApp/Vpn/mobile/Screens/VpnHomeMobile.dart';
...
class VpnSubscriptionDetailMobile extends StatefulWidget {
  ...
  @override
  _VpnSubscriptionDetailStateMobile createState() => _VpnSubscriptionDetailStateMobile();
}

class _VpnSubscriptionDetailStateMobile extends State<VpnSubscriptionDetailMobile> {
  @override
          ...
          children: [
            ...
            GestureDetector(
              onTap: () {
                ...
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => VpnHomeMobile()));
              },
              child: Container(
