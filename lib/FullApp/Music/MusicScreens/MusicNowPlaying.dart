...
class Musicnowplaying extends StatefulWidget {
  Musicnowplaying({Key key}) : super(key: key);

  @override
  _MusicnowplayingState createState() => _MusicnowplayingState();
}

class _MusicnowplayingState extends State<Musicnowplaying> with TickerProviderStateMixin {
