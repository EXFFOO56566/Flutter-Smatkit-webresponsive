...
class MusicFavourite extends StatefulWidget {
  MusicFavourite({Key key}) : super(key: key);

  @override
  _MusicFavouriteState createState() => _MusicFavouriteState();
}

class _MusicFavouriteState extends State<MusicFavourite> {
