...
import 'package:smartkit/FullApp/Music/MusicScreens/MusicNowPlaying.dart';
...
class MusicSubCategory extends StatefulWidget {
  MusicSubCategory({Key key}) : super(key: key);

  @override
  _MusicSubCategoryState createState() => _MusicSubCategoryState();
}

class _MusicSubCategoryState extends State<MusicSubCategory> {
