...
import 'MusicAll.dart';
import 'MusicBottomPanel.dart';
import 'MusicCategory.dart';
import 'MusicFavourite.dart';
import 'MusicFuntions.dart';
import 'MusicHomeTab.dart';
import 'MusicNowPlaying.dart';
        ...
        child: Scaffold(
            ...
            body: SlidingUpPanel(
                ...
                body: getTabBarView(<Widget>[
                  Directionality(textDirection: direction, child: MusicHometab()),
                  Directionality(textDirection: direction, child: MusicCategory()),
                  Directionality(textDirection: direction, child: MusicAll()),
                ]))));
  }
