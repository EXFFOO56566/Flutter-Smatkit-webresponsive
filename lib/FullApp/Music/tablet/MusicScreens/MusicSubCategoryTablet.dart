...
class MusicSubCategoryTablet extends StatefulWidget {
  MusicSubCategoryTablet({Key key}) : super(key: key);

  @override
  _MusicSubCategoryStateTablet createState() => _MusicSubCategoryStateTablet();
}

class _MusicSubCategoryStateTablet extends State<MusicSubCategoryTablet> {
