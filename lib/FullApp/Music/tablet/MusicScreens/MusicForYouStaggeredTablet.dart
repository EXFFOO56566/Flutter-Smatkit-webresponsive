...
class MusicStaggeredListTablet extends StatefulWidget {
  MusicStaggeredListTablet({Key key}) : super(key: key);

  @override
  _MusicStaggeredListStateTablet createState() => _MusicStaggeredListStateTablet();
}

class _MusicStaggeredListStateTablet extends State<MusicStaggeredListTablet> {
  List catList = [
