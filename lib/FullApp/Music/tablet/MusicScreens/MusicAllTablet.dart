...
class MusicAllTablet extends StatefulWidget {
  MusicAllTablet({Key key}) : super(key: key);

  @override
  _MusicAllStateTablet createState() => _MusicAllStateTablet();
}

class _MusicAllStateTablet extends State<MusicAllTablet> {
  @override
  void dispose() {
    player.pause();
    super.dispose();
