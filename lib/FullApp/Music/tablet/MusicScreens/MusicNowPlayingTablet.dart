...
class MusicnowplayingTablet extends StatefulWidget {
  MusicnowplayingTablet({Key key}) : super(key: key);

  @override
  _MusicnowplayingStateTablet createState() => _MusicnowplayingStateTablet();
}

class _MusicnowplayingStateTablet extends State<MusicnowplayingTablet> with TickerProviderStateMixin {
