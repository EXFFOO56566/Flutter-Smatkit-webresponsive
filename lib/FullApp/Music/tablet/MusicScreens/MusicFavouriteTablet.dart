...
class MusicFavouriteTablet extends StatefulWidget {
  MusicFavouriteTablet({Key key}) : super(key: key);

  @override
  _MusicFavouriteStateTablet createState() => _MusicFavouriteStateTablet();
}

class _MusicFavouriteStateTablet extends State<MusicFavouriteTablet> {
