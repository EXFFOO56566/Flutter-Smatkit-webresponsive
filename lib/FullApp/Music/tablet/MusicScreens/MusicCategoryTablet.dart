...
import 'package:smartkit/FullApp/Music/tablet/MusicScreens/MusicSubCategoryTablet.dart';

class MusicCategoryTablet extends StatefulWidget {
  MusicCategoryTablet({Key key}) : super(key: key);

  @override
  _MusicCategoryStateTablet createState() => _MusicCategoryStateTablet();
}

class _MusicCategoryStateTablet extends State<MusicCategoryTablet> {
    ...
    return GestureDetector(
      ...
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => MusicSubCategoryTablet(),
          ),
        );
      },
    );
