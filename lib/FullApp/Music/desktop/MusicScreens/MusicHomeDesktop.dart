...
import 'MusicAllDesktop.dart';
import 'MusicBottomPanelDesktop.dart';
import 'MusicCategoryDesktop.dart';
import 'MusicFavouriteDesktop.dart';
import 'MusicFuntionsDesktop.dart';
import 'MusicHomeTabDesktop.dart';
import 'MusicNowPlayingDesktop.dart';
...
class MusicHomeDesktop extends StatefulWidget {
  MusicHomeDesktop({Key key}) : super(key: key);

  @override
  _MusicHomeStateDesktop createState() => _MusicHomeStateDesktop();
}

class _MusicHomeStateDesktop extends State<MusicHomeDesktop> with TickerProviderStateMixin {
        ...
        child: Scaffold(
            ...
            body: SlidingUpPanel(
                ...
                body: getTabBarView(<Widget>[
                  Directionality(textDirection: direction, child: MusicHometabDesktop()),
                  Directionality(textDirection: direction, child: MusicCategoryDesktop()),
                  Directionality(textDirection: direction, child: MusicAllDesktop()),
                ]))));
  }
