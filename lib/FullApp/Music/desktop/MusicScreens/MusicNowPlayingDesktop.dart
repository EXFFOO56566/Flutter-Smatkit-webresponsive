...
class MusicnowplayingDesktop extends StatefulWidget {
  MusicnowplayingDesktop({Key key}) : super(key: key);

  @override
  _MusicnowplayingStateDesktop createState() => _MusicnowplayingStateDesktop();
}

class _MusicnowplayingStateDesktop extends State<MusicnowplayingDesktop> with TickerProviderStateMixin {
