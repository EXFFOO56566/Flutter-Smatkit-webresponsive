...
class MusicStaggeredListDesktop extends StatefulWidget {
  MusicStaggeredListDesktop({Key key}) : super(key: key);

  @override
  _MusicStaggeredListStateDesktop createState() => _MusicStaggeredListStateDesktop();
}

class _MusicStaggeredListStateDesktop extends State<MusicStaggeredListDesktop> {
  List catList = [
