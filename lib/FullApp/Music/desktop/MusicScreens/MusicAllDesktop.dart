...
class MusicAllDesktop extends StatefulWidget {
  MusicAllDesktop({Key key}) : super(key: key);

  @override
  _MusicAllStateDesktop createState() => _MusicAllStateDesktop();
}

class _MusicAllStateDesktop extends State<MusicAllDesktop> {
  @override
  void dispose() {
    player.pause();
    super.dispose();
