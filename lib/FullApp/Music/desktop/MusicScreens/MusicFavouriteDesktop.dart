...
class MusicFavouriteDesktop extends StatefulWidget {
  MusicFavouriteDesktop({Key key}) : super(key: key);

  @override
  _MusicFavouriteStateDesktop createState() => _MusicFavouriteStateDesktop();
}

class _MusicFavouriteStateDesktop extends State<MusicFavouriteDesktop> {
