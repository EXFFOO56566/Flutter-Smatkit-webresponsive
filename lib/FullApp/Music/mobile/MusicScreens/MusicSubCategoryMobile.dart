...
class MusicSubCategoryMobile extends StatefulWidget {
  MusicSubCategoryMobile({Key key}) : super(key: key);

  @override
  _MusicSubCategoryStateMobile createState() => _MusicSubCategoryStateMobile();
}

class _MusicSubCategoryStateMobile extends State<MusicSubCategoryMobile> {
