...
class MusicAllMobile extends StatefulWidget {
  MusicAllMobile({Key key}) : super(key: key);

  @override
  _MusicAllStateMobile createState() => _MusicAllStateMobile();
}

class _MusicAllStateMobile extends State<MusicAllMobile> {
  @override
  void dispose() {
    player.pause();
    super.dispose();
