...
class MusicStaggeredListMobile extends StatefulWidget {
  MusicStaggeredListMobile({Key key}) : super(key: key);

  @override
  _MusicStaggeredListStateMobile createState() => _MusicStaggeredListStateMobile();
}

class _MusicStaggeredListStateMobile extends State<MusicStaggeredListMobile> {
  List catList = [
