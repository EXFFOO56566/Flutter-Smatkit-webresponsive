...
class HomeMobileState extends State<HomeMobile> {
        ...
        children: List.generate(
            ...
            (i) => GestureDetector(
                  onTap: () {
                    ...
                    Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => HomeActivityMobile()));
                  },
                  child: Container(
      ...
      child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return GestureDetector(
                ...
                onTap: () {
                  Navigator.of(context).push(MaterialPageRoute(builder: (context) => CourseDetailActivityMobile(id: index, type: "savecourse")));
                });
          }),
    );
  }
  ...
  Widget TopRelatedCourse() {
    return Container(
      ...
      children: List.generate(AllCourseList.length > 4 ? 4 : AllCourseList.length, (index) {
        ...
        return SizedBox(
            child: GestureDetector(
                ...
                onTap: () {
                  Navigator.of(context).push(MaterialPageRoute(builder: (context) => CourseDetailActivityMobile(id: index, type: "allcourse")));
                }));
      }),
    ));
  }
      ...
      child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return GestureDetector(
                ...
                onTap: () {
                  Navigator.of(context).push(MaterialPageRoute(builder: (context) => CourseDetailActivityMobile(id: index, type: "mycourse")));
                });
          }),
    );
  }
