...
import 'package:smartkit/FullApp/eStudy/Login/VerificationActivity.dart';
...
class LetsGetStartActivity extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return new LetsGetStartActivityState();
  }
}

class LetsGetStartActivityState extends State<LetsGetStartActivity> {
  @override
  void initState() {
    super.initState();
      ...
      body: new Container(
        child: Column(
          ...
          children: <Widget>[
            ...
            TextButton(
                onPressed: () {
                  Navigator.push(context, MaterialPageRoute(builder: (_) => VerificationActivity()));
                },
                child: Container(
