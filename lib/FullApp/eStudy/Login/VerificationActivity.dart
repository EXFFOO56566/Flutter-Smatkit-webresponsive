...
class VerificationActivity extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return new VerificationActivityState();
  }
}

class VerificationActivityState extends State<VerificationActivity> {
  @override
  void initState() {
    super.initState();
      ...
      body: new Container(
        child: Column(
          ...
          children: <Widget>[
            ...
            TextButton(
                onPressed: () {
                  return Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (context) => HomeActivity()), (Route<dynamic> route) => false);
