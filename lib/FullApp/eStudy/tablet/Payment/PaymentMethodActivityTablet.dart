...
import 'package:smartkit/FullApp/eStudy/tablet/Payment/PaymentSuccessActivityTablet.dart';
...
class PaymentMethodActivityTablet extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return new PaymentMethodActivityTabletState();
  }
}

class PaymentMethodActivityTabletState extends State<PaymentMethodActivityTablet> {
  int _currentIndex;
          ...
          child: Container(
            child: Column(
              ...
              children: <Widget>[
                ...
                TextButton(
                    onPressed: () {
                      Navigator.push(context, MaterialPageRoute(builder: (_) => PaymentSuccessActivityTablet()));
                    },
                    child: Container(
                      margin: EdgeInsets.only(left: 20, right: 20),
                      alignment: Alignment.center,
