...
class PaymentSuccessActivityTablet extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return new PaymentSuccessActivityTabletState();
  }
}

class PaymentSuccessActivityTabletState extends State<PaymentSuccessActivityTablet> {
  @override
  void initState() {
    super.initState();
