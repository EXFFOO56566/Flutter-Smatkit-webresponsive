...
class CreateNewAccountActivityTablet extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return new CreateNewAccountActivityTabletState();
  }
}

class CreateNewAccountActivityTabletState extends State<CreateNewAccountActivityTablet> {
      ...
      body: new Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            TextButton(
              onPressed: () {
                Navigator.push(context, MaterialPageRoute(builder: (_) => LetsGetStartActivityTablet()));
              },
              child: Container(
