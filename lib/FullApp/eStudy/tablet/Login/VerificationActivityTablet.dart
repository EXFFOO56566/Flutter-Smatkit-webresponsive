...
class VerificationActivityTablet extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return new VerificationActivityTabletState();
  }
}

class VerificationActivityTabletState extends State<VerificationActivityTablet> {
  @override
  void initState() {
    super.initState();
      ...
      body: new Container(
        child: Column(
          ...
          children: <Widget>[
            ...
            TextButton(
                onPressed: () {
                  return Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (context) => HomeActivityTablet()), (Route<dynamic> route) => false);
