...
import 'package:smartkit/FullApp/eStudy/tablet/Login/VerificationActivityTablet.dart';
...
class LetsGetStartActivityTablet extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return new LetsGetStartActivityTabletState();
  }
}

class LetsGetStartActivityTabletState extends State<LetsGetStartActivityTablet> {
  @override
  void initState() {
    super.initState();
      ...
      body: new Container(
        child: Column(
          ...
          children: <Widget>[
            ...
            TextButton(
                onPressed: () {
                  Navigator.push(context, MaterialPageRoute(builder: (_) => VerificationActivityTablet()));
                },
                child: Container(
