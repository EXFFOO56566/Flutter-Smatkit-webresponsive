...
import 'package:smartkit/FullApp/eStudy/tablet/Login/LetsGetStartActivityTablet.dart';
...
class CreateNewPasswordActivityTablet extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return new CreateNewPasswordActivityTabletState();
  }
}

class CreateNewPasswordActivityTabletState extends State<CreateNewPasswordActivityTablet> {
      ...
      body: new Container(
        child: Column(
          ...
          children: <Widget>[
            ...
            TextButton(
                onPressed: () {
                  Navigator.pushReplacement(context, MaterialPageRoute(builder: (_) => LoginActivityTablet()));
                },
                child: Text(
