...
import 'SubLessonTablet.dart';

class LessonActivityTablet extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return new LessonActivityTabletState();
  }
}

class LessonActivityTabletState extends State<LessonActivityTablet> with TickerProviderStateMixin {
                ...
                child: ListTile(
                  ...
                  onTap: () {
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (context) => SubLessonTablet(
                          id: index,
                        ),
                      ),
                    );
