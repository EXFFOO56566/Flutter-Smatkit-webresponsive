...
class CourseTablet extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return new CourseTabletState();
  }
}

class CourseTabletState extends State<CourseTablet> with TickerProviderStateMixin {
              ...
              child: GestureDetector(
                  ...
                  onTap: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => CourseDetailActivityTablet(
                              id: index,
                              type: "allcourse",
                            )));
                  }));
