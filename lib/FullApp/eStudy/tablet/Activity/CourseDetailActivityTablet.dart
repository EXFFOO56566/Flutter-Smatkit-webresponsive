...
import 'package:smartkit/FullApp/eStudy/tablet/Payment/PaymentMethodActivityTablet.dart';
...
class CourseDetailActivityTablet extends StatefulWidget {
  int id;
  String type;

  CourseDetailActivityTablet({Key key, this.title, this.id, this.type}) : super(key: key);
  final String title;

  @override
  _CourseDetailActivityTabletState createState() => _CourseDetailActivityTabletState();
}

class _CourseDetailActivityTabletState extends State<CourseDetailActivityTablet> with TickerProviderStateMixin {
  int currentIndex = 0;
              ...
              widget.type == "allcourse"
                  ? Padding(
                      ...
                      child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: <Widget>[
                        ...
                        TextButton(
                            onPressed: () {
                              Navigator.push(context, MaterialPageRoute(builder: (_) => PaymentMethodActivityTablet()));
                            },
                            child: Container(
                              alignment: Alignment.center,
                              height: 50,
