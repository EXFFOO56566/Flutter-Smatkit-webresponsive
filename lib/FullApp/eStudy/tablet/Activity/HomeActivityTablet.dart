import 'dart:io';
import 'package:smartkit/FullApp/eStudy/tablet/Activity/CourseTablet.dart';
import 'package:smartkit/FullApp/eStudy/tablet/Activity/HomeTablet.dart';
import 'package:smartkit/FullApp/eStudy/tablet/Activity/LessonActivityTablet.dart';
import 'package:smartkit/FullApp/eStudy/tablet/Activity/NotificationsTablet.dart';
import 'package:smartkit/FullApp/eStudy/tablet/Activity/ProfileTablet.dart';
...
class HomeActivityTablet extends StatefulWidget {
  HomeActivityTablet({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _HomeActivityTabletState createState() => _HomeActivityTabletState();
}

class _HomeActivityTabletState extends State<HomeActivityTablet> with TickerProviderStateMixin {
