...
import 'package:smartkit/FullApp/eStudy/tablet/Activity/LessonDetailsTablet.dart';

class SubLessonTablet extends StatefulWidget {
  final int id;
  SubLessonTablet({Key key, this.id}) : super(key: key);

  @override
  _SubLessonTabletState createState() => _SubLessonTabletState();
}

class _SubLessonTabletState extends State<SubLessonTablet> {
  @override
                    ...
                    return ListTile(
                      ...
                      onTap: () {
                        Navigator.of(context).push(
                          MaterialPageRoute(
                            builder: (context) => LessonDetailsTablet(
                              id: widget.id,
                              idvideo: index,
                            ),
                          ),
