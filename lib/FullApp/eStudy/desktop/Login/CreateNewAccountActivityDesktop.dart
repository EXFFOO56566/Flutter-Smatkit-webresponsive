...
class CreateNewAccountActivityDesktop extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return new CreateNewAccountActivityDesktopState();
  }
}

class CreateNewAccountActivityDesktopState extends State<CreateNewAccountActivityDesktop> {
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      TextButton(
                        onPressed: () {
                          Navigator.push(context, MaterialPageRoute(builder: (_) => LetsGetStartActivityDesktop()));
                        },
                        child: Container(
