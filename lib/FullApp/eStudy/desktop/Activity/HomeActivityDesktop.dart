...
import 'package:smartkit/FullApp/eStudy/desktop/Activity/CourseDesktop.dart';
import 'package:smartkit/FullApp/eStudy/desktop/Activity/HomeDesktop.dart';
import 'package:smartkit/FullApp/eStudy/desktop/Activity/LessonActivityDesktop.dart';
import 'package:smartkit/FullApp/eStudy/desktop/Activity/NotificationsDesktop.dart';
import 'package:smartkit/FullApp/eStudy/desktop/Activity/ProfileDesktop.dart';
...
class HomeActivityDesktop extends StatefulWidget {
  HomeActivityDesktop({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _HomeActivityDesktopState createState() => _HomeActivityDesktopState();
}

class _HomeActivityDesktopState extends State<HomeActivityDesktop> with TickerProviderStateMixin {
    ...
    if (backButtonHasNotBeenPressedOrSnackBarHasBeenClosed) {
      ...
      setState(() {
        Navigator.pushReplacement(
            context,
            MaterialPageRoute(
              builder: (context) => HomeActivityDesktop(),
            ));
      });
      return false;
    }
