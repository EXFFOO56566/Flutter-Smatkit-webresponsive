...
import 'package:smartkit/FullApp/eStudy/desktop/Payment/PaymentMethodActivityDesktop.dart';
...
class CourseDetailActivityDesktop extends StatefulWidget {
  int id;
  String type;

  CourseDetailActivityDesktop({Key key, this.title, this.id, this.type}) : super(key: key);
  final String title;

  @override
  _CourseDetailActivityDesktopState createState() => _CourseDetailActivityDesktopState();
}

class _CourseDetailActivityDesktopState extends State<CourseDetailActivityDesktop> with TickerProviderStateMixin {
  int currentIndex = 0;
        ...
        body: CustomScrollView(
          slivers: <Widget>[
            SliverAppBar(
              ...
              expandedHeight: /*MediaQuery.of(context).size.height * .4*/0,
              backgroundColor: ColorsRes.bgcolor,
              leading: IconButton(
              ...
              widget.type == "allcourse"
                  ? Padding(
                      ...
                      child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: <Widget>[
                        ...
                        TextButton(
                            onPressed: () {
                              Navigator.push(context, MaterialPageRoute(builder: (_) => PaymentMethodActivityDesktop()));
                            },
                            child: Container(
                              alignment: Alignment.center,
                              height: 50,
                            ...
                            child: Column(children:[Row(children:[
                              Expanded(
                                child: Stack(children: [
                                  ...
                                  Container(
                                    margin: EdgeInsets.only(left: 20, top: MediaQuery.of(context).size.height * .30),
                                    child: Row(
