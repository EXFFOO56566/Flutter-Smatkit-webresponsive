...
import 'package:smartkit/FullApp/eStudy/desktop/Activity/CourseDetailActivityDesktop.dart';
...
class HomeDesktopState extends State<HomeDesktop> {
          ...
          children: List.generate(
              ...
              (i) => GestureDetector(
                    onTap: () {
                      ...
                      Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => HomeActivityDesktop()));
                    },
                    child: Container(
  ...
  Widget DisplayPopularCourse(bool isrow) {
    return SizedBox(
      height: isrow ? trendingheight : MediaQuery.of(context).size.height * .5,
          ...
          itemBuilder: (context, index) {
            ...
            return GestureDetector(
                child: Container(
                  ...
                  child: Container(
                      height: MediaQuery.of(context).size.height * .5,
                      width: isrow ? 300 : MediaQuery.of(context).size.height * .5,
                      child: isrow
                          ? Row(children: <Widget>[
                              Expanded(child: DesignConfig.DisplayCourseImage(SavedCourseList[index].imageList[1].image, 100, 80)),
                              Expanded(
                                child: Column(
                ...
                onTap: () {
                  Navigator.of(context).push(MaterialPageRoute(builder: (context) => CourseDetailActivityDesktop(id: index, type: "savecourse")));
                });
          }),
    );
  }
      ...
      children: List.generate(AllCourseList.length > 3 ? 3 : AllCourseList.length, (index) {
        ...
        return SizedBox(
            child: GestureDetector(
                ...
                onTap: () {
                  Navigator.of(context).push(MaterialPageRoute(builder: (context) => CourseDetailActivityDesktop(id: index, type: "allcourse")));
                }));
      }),
    ));
  }
  ...
  Widget DisplayNewCourse(bool isrow) {
    return SizedBox(
      height: isrow ? trendingheight : MediaQuery.of(context).size.width * .3,
      child: ListView.builder(
          scrollDirection: Axis.horizontal,
          ...
          itemBuilder: (context, index) {
            ...
            return GestureDetector(
                child: Container(
                  ...
                  child: Container(
                      height: MediaQuery.of(context).size.height * .3,
                      width: isrow ? 300 : MediaQuery.of(context).size.width * .3,
                      child: isrow
                          ? Row(children: <Widget>[
                              Expanded(child: DesignConfig.DisplayCourseImage(MyCourseList[index].imageList[1].image, 100, 80)),
                              Expanded(
                                child: Column(
                                  mainAxisSize: MainAxisSize.min,
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  ...
                                  children: <Widget>[
                                    ...
                                    Expanded(child: DesignConfig.DisplayCoursePriceMy_course(myCourse, false, false)),
                                  ],
                                ),
                              ),
                            ])
                          : Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.start, children: <Widget>[
                              Expanded(
                                child: CachedNetworkImage(
                ...
                onTap: () {
                  Navigator.of(context).push(MaterialPageRoute(builder: (context) => CourseDetailActivityDesktop(id: index, type: "mycourse")));
                });
          }),
    );
  }
  ...
  Widget DisplayTopRatedCourse(bool isrow) {
    return SizedBox(
      height: isrow ? trendingheight : MediaQuery.of(context).size.height * .32,
      child: ListView.builder(
          scrollDirection: Axis.horizontal,
            ...
            return GestureDetector(
                child: Container(
                  ...
                  child: Container(
                      ...
                      child: isrow
                          ? Row(children: <Widget>[
                              Expanded(child: DesignConfig.DisplayCourseImage(AllCourseList[index].imageList[1].image, 100, 80)),
                              Expanded(
                                child: Column(
                                  mainAxisSize: MainAxisSize.min,
                                  crossAxisAlignment: CrossAxisAlignment.start,
                          ...
                          : Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.spaceBetween, children: <Widget>[
                              Expanded(
                                child: CachedNetworkImage(
                                  imageUrl: AllCourseList[index].imageList[1].image,
                                  fit: BoxFit.fill,
        ...
        SliverAppBar(
          ...
          flexibleSpace: FlexibleSpaceBar(
              ...
              background: Stack(children: [
                ...
                Container(
                  margin: EdgeInsets.only(left: 20, right: 20, top: MediaQuery.of(context).size.height * .24),
                  decoration: DesignConfig.boxDecorationContainer(ColorsRes.white, 10),
                  child: Container(
                    height: 43,
