...
import 'LessonDetailsDesktop.dart';

class SubLessonDesktop extends StatefulWidget {
  final int id;
  SubLessonDesktop({Key key, this.id}) : super(key: key);

  @override
  _SubLessonDesktopState createState() => _SubLessonDesktopState();
}

class _SubLessonDesktopState extends State<SubLessonDesktop> {
  @override
                    ...
                    return ListTile(
                      ...
                      onTap: () {
                        Navigator.of(context).push(
                          MaterialPageRoute(
                            builder: (context) => LessonDetailsDesktop(
                              id: widget.id,
                              idvideo: index,
                            ),
                          ),
