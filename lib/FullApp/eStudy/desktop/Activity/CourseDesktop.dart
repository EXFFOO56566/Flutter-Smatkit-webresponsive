...
class CourseDesktop extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return new CourseDesktopState();
  }
}

class CourseDesktopState extends State<CourseDesktop> with TickerProviderStateMixin {
              ...
              child: GestureDetector(
                  ...
                  onTap: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => CourseDetailActivityDesktop(
                              id: index,
                              type: "allcourse",
                            )));
                  }));
