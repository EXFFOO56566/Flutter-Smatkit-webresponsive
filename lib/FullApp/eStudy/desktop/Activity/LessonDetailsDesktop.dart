...
class LessonDetailsDesktop extends StatefulWidget {
  final int idvideo, id;
  LessonDetailsDesktop({Key key, this.id, this.idvideo}) : super(key: key);

  @override
  _LessonDetailsDesktopState createState() => _LessonDetailsDesktopState();
}

class _LessonDetailsDesktopState extends State<LessonDetailsDesktop> {
