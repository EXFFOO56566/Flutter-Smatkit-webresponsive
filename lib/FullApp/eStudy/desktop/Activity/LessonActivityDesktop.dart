...
import 'SubLessonDesktop.dart';

class LessonActivityDesktop extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return new LessonActivityDesktopState();
  }
}

class LessonActivityDesktopState extends State<LessonActivityDesktop> with TickerProviderStateMixin {
                ...
                child: ListTile(
                  ...
                  onTap: () {
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (context) => SubLessonDesktop(
                          id: index,
                        ),
                      ),
                    );
