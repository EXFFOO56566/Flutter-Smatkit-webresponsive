...
import 'package:smartkit/FullApp/eStudy/Payment/PaymentMethodActivity.dart';
...
class CourseDetailActivity extends StatefulWidget {
  int id;
  String type;

  CourseDetailActivity({Key key, this.title, this.id, this.type}) : super(key: key);
  final String title;

  @override
  _CourseDetailActivityState createState() => _CourseDetailActivityState();
}

class _CourseDetailActivityState extends State<CourseDetailActivity> with TickerProviderStateMixin {
  int currentIndex = 0;
              ...
              widget.type == "allcourse"
                  ? Padding(
                      ...
                      child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: <Widget>[
                        ...
                        TextButton(
                            onPressed: () {
                              Navigator.push(context, MaterialPageRoute(builder: (_) => PaymentMethodActivity()));
                            },
                            child: Container(
                              alignment: Alignment.center,
                              height: 50,
