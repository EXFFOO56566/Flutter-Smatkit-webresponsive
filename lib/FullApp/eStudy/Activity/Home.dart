...
import 'package:smartkit/FullApp/eStudy/Activity/CourseDetailActivity.dart';
      ...
      child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return GestureDetector(
                ...
                onTap: () {
                  Navigator.of(context).push(MaterialPageRoute(builder: (context) => CourseDetailActivity(id: index, type: "savecourse")));
                });
          }),
    );
  }
      ...
      children: List.generate(AllCourseList.length > 4 ? 4 : AllCourseList.length, (index) {
        ...
        return SizedBox(
            child: GestureDetector(
                ...
                onTap: () {
                  Navigator.of(context).push(MaterialPageRoute(builder: (context) => CourseDetailActivity(id: index, type: "allcourse")));
                }));
      }),
    ));
  }
      ...
      child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return GestureDetector(
                ...
                onTap: () {
                  Navigator.of(context).push(MaterialPageRoute(builder: (context) => CourseDetailActivity(id: index, type: "mycourse")));
                });
          }),
    );
  }
