...
import 'package:smartkit/FullApp/FoodMaster/activity/authentication/SignupActivity.dart';
            ...
            Expanded(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: GestureDetector(
                    onTap: () {
                      Navigator.of(context).push(CupertinoPageRoute(builder: (context) => SignupActivity(from: "loginhome")));
                    },
                ...
                RichText(
                  ...
                  TextSpan(
                      ...
                      recognizer: TapGestureRecognizer()
                        ..onTap = () {
                          Navigator.of(context).push(CupertinoPageRoute(builder: (context) => LoginActivity()));
                        }),
                ])),
                SizedBox(
                  height: 50,
