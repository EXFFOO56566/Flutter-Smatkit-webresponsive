...
class Order_PlaceTablet extends StatefulWidget {
  @override
  _Order_PlaceTablet createState() => _Order_PlaceTablet();
}

class _Order_PlaceTablet extends State<Order_PlaceTablet> {
  @override
  void initState() {
    super.initState();
    imageCache.clear();
