...
import 'SignupActivityDesktop.dart';

GlobalKey<ScaffoldState> scaffoldKey;

class LoginActivityDesktop extends StatefulWidget {
  @override
  _LoginActivityStateDesktop createState() => _LoginActivityStateDesktop();
}

class _LoginActivityStateDesktop extends State<LoginActivityDesktop> {
                                    ...
                                    RichText(
                                      ...
                                      TextSpan(
                                          ...
                                          recognizer: TapGestureRecognizer()
                                            ..onTap = () {
                                              Navigator.of(context).push(CupertinoPageRoute(builder: (context) => SignupActivityDesktop(from: "login")));
                                            }),
                                    ])),
                                    SizedBox(
                                      height: 35,
