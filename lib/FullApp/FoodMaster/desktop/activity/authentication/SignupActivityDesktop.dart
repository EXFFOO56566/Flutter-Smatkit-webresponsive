...
class SignupActivityDesktop extends StatefulWidget {
  final String from;
  const SignupActivityDesktop({
    Key key,
    this.from,
  }) : super(key: key);
  @override
  _SignupActivityStateDesktop createState() => _SignupActivityStateDesktop();
}

class _SignupActivityStateDesktop extends State<SignupActivityDesktop> {
