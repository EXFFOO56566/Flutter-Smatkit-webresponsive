...
import 'package:smartkit/FullApp/NewsApp/desktop/helper/ZoomImage/photo_view.dart' show PhotoViewControllerBase, PhotoViewScaleState, PhotoViewScaleStateController, ScaleStateCycle;
...
mixin PhotoViewControllerDelegate on State<PhotoViewCore> {
  ...
  void updateMultiple({
    ...
    controller.updateMultiple(position: position, scale: scale, rotation: rotation, rotationFocusPoint: rotationFocusPoint);
  }

  void updateScaleStateFromNewScale(double newScale) {
    final PhotoViewScaleState newScaleState = (newScale > scaleBoundaries.initialScale) ? PhotoViewScaleState.zoomedIn : PhotoViewScaleState.zoomedOut;
