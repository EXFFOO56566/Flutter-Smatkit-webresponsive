...
class LiveVideoDetailDesktop extends StatefulWidget {
  @override
  _LiveVideoDetailStateDesktop createState() => _LiveVideoDetailStateDesktop();
}

class _LiveVideoDetailStateDesktop extends State<LiveVideoDetailDesktop> {
          ...
          if (!overlayProvider.inPipMode)
            Positioned(
              ...
              child: IconButton(
                  ...
                  color: Colors.white,
                  onPressed: () {
                    Provider.of<OverlayHandlerProviderDesktop>(context, listen: false).enablePip(aspectRatio);
                  }),
            ),
          if (overlayProvider.inPipMode)
            Positioned(
              ...
              child: InkWell(
                onTap: () {
                  Provider.of<OverlayHandlerProviderDesktop>(context, listen: false).disablePip();
                },
                child: Container(),
              ),
            ),
