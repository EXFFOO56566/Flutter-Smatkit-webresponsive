...
class SignupPageDesktop extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return SignupPageStateDesktop();
  }
}

class SignupPageStateDesktop extends State<SignupPageDesktop> {
                              ...
                              child: Row(children: [
                                CircleAvatar(
                                  ...
                                  child: CachedNetworkImage(
                                    imageUrl: "https://smartkit.wrteam.in/smartkit/newsapp/male.png",
                                  ),
                                ),
                                SizedBox(width: 10),
                                Text(
                            ...
                            GestureDetector(
                              ...
                              child: Row(children: [
                                CircleAvatar(
                                  ...
                                  child: CachedNetworkImage(
                                    imageUrl: "https://smartkit.wrteam.in/smartkit/newsapp/female.png",
                                  ),
                                ),
                                SizedBox(width: 10),
                                Text(
