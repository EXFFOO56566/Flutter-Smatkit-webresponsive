...
import 'package:smartkit/FullApp/NewsApp/desktop/activity/CommentListDesktop.dart';
import 'package:smartkit/FullApp/NewsApp/desktop/activity/FullScreenImageDesktop.dart';
import 'package:smartkit/FullApp/NewsApp/desktop/activity/MainActivityDesktop.dart';
...
class NewsDetailDesktop extends StatefulWidget {
  @override
  _NewsDetailStateDesktop createState() => _NewsDetailStateDesktop();
}

class _NewsDetailStateDesktop extends State<NewsDetailDesktop> {
  @override
  ...
  Widget imageWidget() {
    return ButtonClickAnimation(
        onTap: () {
          Navigator.of(context).push(CupertinoPageRoute(builder: (context) => FullScreenImageDesktop(selectednews.image)));
        },
        child: Card(
