...
import 'package:smartkit/FullApp/NewsApp/desktop/activity/Home/NewsDetailDesktop.dart';
import 'package:smartkit/FullApp/NewsApp/desktop/activity/NotificationListDesktop.dart';
import 'package:smartkit/FullApp/NewsApp/desktop/activity/Profile/NewArticleDesktop.dart';
import 'package:smartkit/FullApp/NewsApp/desktop/activity/SearchPageDesktop.dart';
...
import '../MainActivityDesktop.dart';

class HomePageDesktop extends StatefulWidget {
  @override
  _HomePageStateDesktop createState() => _HomePageStateDesktop();
}

class _HomePageStateDesktop extends State<HomePageDesktop> with TickerProviderStateMixin {
                  ...
                  return <Widget>[
                    SliverAppBar(
                      ...
                      leading: IconButton(
                        ...
                        onPressed: () {
                          Navigator.of(context).push(CupertinoPageRoute(builder: (context) => NewArticleDesktop()));
                        },
                      ),
                      ...
                      actions: <Widget>[
                        IconButton(
                            ...
                            onPressed: () {
                              Navigator.of(context).push(CupertinoPageRoute(builder: (context) => SearchPageDesktop()));
                            }),
                        IconButton(
      ...
      child: ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            ...
            return ButtonClickAnimation(
              onTap: () {
                selectednews = item;
                Navigator.of(context).push(CupertinoPageRoute(builder: (context) => NewsDetailDesktop()));
              },
              child: Container(
                width: 230,
                height: 220,
