...
class StartupMediaPageDesktop extends StatefulWidget {
  @override
  _StartupMediaPageStateDesktop createState() => _StartupMediaPageStateDesktop();
}

class _StartupMediaPageStateDesktop extends State<StartupMediaPageDesktop> {
