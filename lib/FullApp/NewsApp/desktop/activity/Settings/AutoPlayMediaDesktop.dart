...
class AutoPlayMediaDesktop extends StatefulWidget {
  @override
  _AutoPlayMediaStateDesktop createState() => _AutoPlayMediaStateDesktop();
}

class _AutoPlayMediaStateDesktop extends State<AutoPlayMediaDesktop> {
