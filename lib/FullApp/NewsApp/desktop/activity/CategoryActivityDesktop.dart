...
import 'package:smartkit/FullApp/NewsApp/desktop/helper/new_dialog.dart';
import 'package:smartkit/FullApp/NewsApp/model/Category.dart';
import 'package:smartkit/FullApp/NewsApp/model/Language.dart';

class CategoryActivityDesktop extends StatefulWidget {
  @override
  _CategoryActivityStateDesktop createState() => _CategoryActivityStateDesktop();
}

class _CategoryActivityStateDesktop extends State<CategoryActivityDesktop> {
        ...
        body: GridView.count(
            ...
            children: List.generate(categorylist.length, (index) {
              ...
              return ButtonClickAnimation(
                  onTap: () {
                    Navigator.of(context).pushReplacement(CupertinoPageRoute(builder: (context) => MainActivityDesktop()));
                  },
                  child: Column(
                    children: [
                      Expanded(
