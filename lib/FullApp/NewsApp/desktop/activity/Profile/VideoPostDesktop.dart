...
class VideoPostDesktop extends StatefulWidget {
  @override
  _VideoPostStateDesktop createState() => _VideoPostStateDesktop();
}

class _VideoPostStateDesktop extends State<VideoPostDesktop> {
  List<Article> mypost;
