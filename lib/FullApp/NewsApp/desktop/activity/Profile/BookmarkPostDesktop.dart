...
class BookmarkPostDesktop extends StatefulWidget {
  @override
  _BookmarkPostStateDesktop createState() => _BookmarkPostStateDesktop();
}

class _BookmarkPostStateDesktop extends State<BookmarkPostDesktop> {
  List<Article> mypost;
