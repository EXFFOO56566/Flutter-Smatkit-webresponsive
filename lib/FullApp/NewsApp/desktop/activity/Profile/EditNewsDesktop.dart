...
class EditNewsDesktop extends StatefulWidget {
  @override
  _EditNewsStateDesktop createState() => _EditNewsStateDesktop();
}

class _EditNewsStateDesktop extends State<EditNewsDesktop> {
