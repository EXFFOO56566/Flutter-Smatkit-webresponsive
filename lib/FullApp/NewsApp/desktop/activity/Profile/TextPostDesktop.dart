...
import 'package:smartkit/FullApp/NewsApp/desktop/activity/Profile/EditNewsDesktop.dart';
...
class TextPostDesktop extends StatefulWidget {
  @override
  _TextPostStateDesktop createState() => _TextPostStateDesktop();
}

class _TextPostStateDesktop extends State<TextPostDesktop> {
  List<Article> mypost;
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: <Widget>[
                ...
                Expanded(
                  ...
                  children: [
                    ...
                    SizedBox(height: 5),
                    Text("${item.shortdesc}", maxLines: 1, overflow: TextOverflow.ellipsis, style: Theme.of(context).textTheme.bodyText2.merge(TextStyle(color: ColorsRes.grey))),
                    SizedBox(height: 5),
                    Align(
                      alignment: Alignment.centerRight,
                      child: Text("${item.author} ", maxLines: 1, overflow: TextOverflow.ellipsis, style: Theme.of(context).textTheme.caption.merge(TextStyle(color: ColorsRes.blue))),
                    ),
                    SizedBox(height: 8),
                    Padding(
                      ...
                      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                        ...
                        GestureDetector(
                            onTap: () {
                              selectednews = item;
                              Navigator.of(context).push(CupertinoPageRoute(builder: (context) => EditNewsDesktop()));
                            },
                            child: Icon(
                              Icons.edit,
                              color: ColorsRes.grey.withOpacity(0.5),
