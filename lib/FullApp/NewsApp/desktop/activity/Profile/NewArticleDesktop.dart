...
import 'package:smartkit/FullApp/NewsApp/desktop/helper/DashedBorder/dotted_border.dart';
...
class NewArticleDesktop extends StatefulWidget {
  @override
  _NewArticleStateDesktop createState() => _NewArticleStateDesktop();
}

class _NewArticleStateDesktop extends State<NewArticleDesktop> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Center(child: SizedBox(height: 800, width: 800, child: SingleChildScrollView(padding: EdgeInsets.symmetric(horizontal: 15, vertical: 15), child: newArticleForm()))),
    );
  }
