...
import 'package:smartkit/FullApp/NewsApp/desktop/activity/Profile/TextPostDesktop.dart';
import 'package:smartkit/FullApp/NewsApp/desktop/activity/Profile/BookmarkPostDesktop.dart';
import 'package:smartkit/FullApp/NewsApp/desktop/activity/Profile/VideoPostDesktop.dart';
...
import 'AudioPostDesktop.dart';

class ProfilePageDesktop extends StatefulWidget {
  @override
  _ProfilePageStateDesktop createState() => _ProfilePageStateDesktop();
}

class _ProfilePageStateDesktop extends State<ProfilePageDesktop> with SingleTickerProviderStateMixin {
  ScrollController scrollController;
  bool silverCollapsed = false;
  String myTitle = "WRTeam";
  double expandheight = 220;
        ...
        child: NestedScrollView(
          ...
          body: Container(
            ...
            child: new TabBarView(
              ...
              children: <Widget>[
                new TextPostDesktop(),
                new VideoPostDesktop(),
                new AudioPostDesktop(),
                new BookmarkPostDesktop(),
              ],
            ),
          ),
        ),
