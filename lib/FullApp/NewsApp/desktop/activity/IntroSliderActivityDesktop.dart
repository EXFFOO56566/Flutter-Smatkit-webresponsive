...
import 'package:smartkit/FullApp/NewsApp/desktop/activity/Login/LoginPageDesktop.dart';
...
class IntroSliderActivityDesktop extends StatefulWidget {
  @override
  IntroSliderStateDesktop createState() => new IntroSliderStateDesktop();
}

class IntroSliderStateDesktop extends State<IntroSliderActivityDesktop> {
            ...
            child: Align(
              ...
              child: Container(
                ...
                child: FloatingActionButton(
                  onPressed: () {
                    Navigator.of(context).pushReplacement(CupertinoPageRoute(builder: (context) => LoginPageDesktop()));
                  },
