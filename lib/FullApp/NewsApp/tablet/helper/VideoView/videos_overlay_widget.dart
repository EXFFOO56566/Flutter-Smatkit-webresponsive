...
class _VideoOverlayWidgetState extends State<VideoOverlayWidget> {
  ...
  _onPipMode() {
    double aspectRatio = Provider.of<OverlayHandlerProviderTablet>(context, listen: false).aspectRatio;
...
//    Provider.of<OverlayHandlerProvider>(context, listen: false).enablePip();
    Future.delayed(Duration(milliseconds: 100), () {
      ...
      bool isfullscreen = Provider.of<OverlayHandlerProviderTablet>(context, listen: false).isfullscreen;
