...
import 'package:smartkit/FullApp/NewsApp/tablet/helper/VideoView/videos_overlay_widget.dart';
import 'package:smartkit/FullApp/NewsApp/tablet/helper/VideoView/videos_title_overlay_widget.dart';
...
class OverlayService {
  addVideosOverlay(BuildContext context, Widget widget) {
    ...
    Provider.of<OverlayHandlerProviderTablet>(context, listen: false).insertOverlay(context, overlayEntry);
  }
