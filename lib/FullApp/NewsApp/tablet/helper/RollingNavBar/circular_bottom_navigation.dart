  ...
  Widget build(BuildContext context) {
    ...
    children.add(Positioned(
      child: Container(
        ...
        decoration: BoxDecoration(shape: BoxShape.rectangle, color: widget.barBackgroundColor, boxShadow: [new BoxShadow(color: Colors.grey, blurRadius: 2.0)]),
      ),
        ...
        Positioned(
          child: Transform.scale(
            ...
            child: widget.tabItems[pos].icon == null
                ? CachedNetworkImage(
                    imageUrl: "https://smartkit.wrteam.in/smartkit/newsapp/${widget.tabItems[pos].image}",
                    color: iconColor,
