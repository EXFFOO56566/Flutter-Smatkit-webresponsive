...
import 'package:smartkit/FullApp/NewsApp/tablet/activity/MainActivityTablet.dart';
import 'package:smartkit/FullApp/NewsApp/tablet/activity/CommentListTablet.dart';
import 'package:smartkit/FullApp/NewsApp/tablet/activity/FullScreenImageTablet.dart';

class NewsDetailTablet extends StatefulWidget {
  @override
  _NewsDetailStateTablet createState() => _NewsDetailStateTablet();
}

class _NewsDetailStateTablet extends State<NewsDetailTablet> {
  @override
  ...
  Widget imageWidget() {
    return ButtonClickAnimation(
        onTap: () {
          Navigator.of(context).push(CupertinoPageRoute(builder: (context) => FullScreenImageTablet(selectednews.image)));
        },
        child: Card(
