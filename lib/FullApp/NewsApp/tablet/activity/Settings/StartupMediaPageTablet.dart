...
class StartupMediaPageTablet extends StatefulWidget {
  @override
  _StartupMediaPageStateTablet createState() => _StartupMediaPageStateTablet();
}

class _StartupMediaPageStateTablet extends State<StartupMediaPageTablet> {
