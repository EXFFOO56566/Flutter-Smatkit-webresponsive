...
class AutoPlayMediaTablet extends StatefulWidget {
  @override
  _AutoPlayMediaStateTablet createState() => _AutoPlayMediaStateTablet();
}

class _AutoPlayMediaStateTablet extends State<AutoPlayMediaTablet> {
