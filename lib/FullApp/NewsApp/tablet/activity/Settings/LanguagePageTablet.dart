...
class LanguagePageTablet extends StatefulWidget {
  @override
  _LanguagePageStateTablet createState() => _LanguagePageStateTablet();
}

class _LanguagePageStateTablet extends State<LanguagePageTablet> {
