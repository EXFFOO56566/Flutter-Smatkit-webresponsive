...
class FeedbackPageTablet extends StatefulWidget {
  @override
  _FeedbackPageStateTablet createState() => _FeedbackPageStateTablet();
}

class _FeedbackPageStateTablet extends State<FeedbackPageTablet> {
