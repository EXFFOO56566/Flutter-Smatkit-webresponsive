...
class SignupPageTablet extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return SignupPageStateTablet();
  }
}

class SignupPageStateTablet extends State<SignupPageTablet> {
                          ...
                          child: Row(children: [
                            CircleAvatar(
                              ...
                              child: CachedNetworkImage(
                                imageUrl: "https://smartkit.wrteam.in/smartkit/male.png",
                              ),
                            ),
                            SizedBox(width: 10),
                            Text(
                        ...
                        GestureDetector(
                          ...
                          child: Row(children: [
                            CircleAvatar(
                              ...
                              child: CachedNetworkImage(
                                imageUrl: "https://smartkit.wrteam.in/smartkit/female.png",
                              ),
                            ),
                            SizedBox(width: 10),
                            Text(
