...
class CategoryActivityTablet extends StatefulWidget {
  @override
  _CategoryActivityStateTablet createState() => _CategoryActivityStateTablet();
}

class _CategoryActivityStateTablet extends State<CategoryActivityTablet> {
        ...
        body: GridView.count(
            ...
            children: List.generate(categorylist.length, (index) {
              ...
              return ButtonClickAnimation(
                  onTap: () {
                    Navigator.of(context).pushReplacement(CupertinoPageRoute(builder: (context) => MainActivityTablet()));
                  },
                  child: Column(
                    children: [
                      Expanded(
