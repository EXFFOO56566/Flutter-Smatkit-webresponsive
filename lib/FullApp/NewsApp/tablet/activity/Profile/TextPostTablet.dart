...
import 'package:smartkit/FullApp/NewsApp/tablet/activity/Profile/EditNewsTablet.dart';

import '../MainActivityTablet.dart';
import '../CommentListTablet.dart';

class TextPostTablet extends StatefulWidget {
  @override
  _TextPostStateTablet createState() => _TextPostStateTablet();
}

class _TextPostStateTablet extends State<TextPostTablet> {
  List<Article> mypost;
                    ...
                    Padding(
                      ...
                      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                        ...
                        GestureDetector(
                            onTap: () {
                              selectednews = item;
                              Navigator.of(context).push(CupertinoPageRoute(builder: (context) => EditNewsTablet()));
                            },
                            child: Icon(
                              Icons.edit,
                              color: ColorsRes.grey.withOpacity(0.5),
