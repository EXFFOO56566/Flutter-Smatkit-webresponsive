...
import 'package:smartkit/FullApp/NewsApp/tablet/helper/DashedBorder/dotted_border.dart';
...
class NewArticleTablet extends StatefulWidget {
  @override
  _NewArticleStateTablet createState() => _NewArticleStateTablet();
}

class _NewArticleStateTablet extends State<NewArticleTablet> {
