...
class EditNewsTablet extends StatefulWidget {
  @override
  _EditNewsStateTablet createState() => _EditNewsStateTablet();
}

class _EditNewsStateTablet extends State<EditNewsTablet> {
