...
import 'package:smartkit/FullApp/NewsApp/tablet/activity/Profile/BookmarkPostTablet.dart';
import 'package:smartkit/FullApp/NewsApp/tablet/activity/Profile/NewArticleTablet.dart';
import 'package:smartkit/FullApp/NewsApp/tablet/activity/Profile/TextPostTablet.dart';
import 'package:smartkit/FullApp/NewsApp/tablet/activity/Profile/VideoPostTablet.dart';

import 'AudioPostTablet.dart';

class ProfilePageTablet extends StatefulWidget {
  @override
  _ProfilePageStateTablet createState() => _ProfilePageStateTablet();
}

class _ProfilePageStateTablet extends State<ProfilePageTablet> with SingleTickerProviderStateMixin {
    ...
    return Column(
      ...
      children: [
        ButtonClickAnimation(
            ...
            child: Padding(
              padding: const EdgeInsets.only(right: 15, top: 25, bottom: 5),
