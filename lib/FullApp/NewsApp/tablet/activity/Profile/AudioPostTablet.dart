...
class AudioPostTablet extends StatefulWidget {
  @override
  _AudioPostStateTablet createState() => _AudioPostStateTablet();
}

class _AudioPostStateTablet extends State<AudioPostTablet> {
  List<Article> mypost;
