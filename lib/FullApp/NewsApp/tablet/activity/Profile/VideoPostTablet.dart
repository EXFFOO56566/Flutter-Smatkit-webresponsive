...
class VideoPostTablet extends StatefulWidget {
  @override
  _VideoPostStateTablet createState() => _VideoPostStateTablet();
}

class _VideoPostStateTablet extends State<VideoPostTablet> {
  List<Article> mypost;
