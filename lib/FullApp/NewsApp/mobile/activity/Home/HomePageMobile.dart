...
import 'package:smartkit/FullApp/NewsApp/mobile/activity/Home/NewsDetailMobile.dart';
...
import 'package:smartkit/FullApp/NewsApp/mobile/activity/SearchPageMobile.dart';
...
import '../MainActivityMobile.dart';

class HomePageMobile extends StatefulWidget {
  @override
  _HomePageStateMobile createState() => _HomePageStateMobile();
}

class _HomePageStateMobile extends State<HomePageMobile> with TickerProviderStateMixin {
                    ...
                    SliverAppBar(
                      ...
                      actions: <Widget>[
                        IconButton(
                            ...
                            onPressed: () {
                              Navigator.of(context).push(CupertinoPageRoute(builder: (context) => SearchPageMobile()));
                            }),
                        IconButton(
      ...
      child: ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            ...
            return ButtonClickAnimation(
              onTap: () {
                selectednews = item;
                Navigator.of(context).push(CupertinoPageRoute(builder: (context) => NewsDetailMobile()));
              },
              child: Container(
                width: 230,
                height: 220,
