...
class LiveVideoDetailMobile extends StatefulWidget {
  @override
  _LiveVideoDetailStateMobile createState() => _LiveVideoDetailStateMobile();
}

class _LiveVideoDetailStateMobile extends State<LiveVideoDetailMobile> {
          ...
          if (!overlayProvider.inPipMode)
            Positioned(
              ...
              child: IconButton(
                  ...
                  color: Colors.white,
                  onPressed: () {
                    Provider.of<OverlayHandlerProviderMobile>(context, listen: false).enablePip(aspectRatio);
                  }),
            ),
          if (overlayProvider.inPipMode)
            Positioned(
              ...
              child: InkWell(
                onTap: () {
                  Provider.of<OverlayHandlerProviderMobile>(context, listen: false).disablePip();
                },
                child: Container(),
              ),
            ),
