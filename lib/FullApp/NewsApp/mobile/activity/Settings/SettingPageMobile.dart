...
import 'package:smartkit/FullApp/NewsApp/mobile/activity/Settings/AutoPlayMediaMobile.dart';
import 'package:smartkit/FullApp/NewsApp/mobile/activity/Settings/LanguagePageMobile.dart';
import 'package:smartkit/FullApp/NewsApp/mobile/activity/Settings/StartupMediaPageMobile.dart';
import 'package:smartkit/FullApp/NewsApp/mobile/activity/Settings/TextSizePageMobile.dart';

class SettingPageMobile extends StatefulWidget {
  @override
  _SettingPageStateMobile createState() => _SettingPageStateMobile();
}

class _SettingPageStateMobile extends State<SettingPageMobile> {
          ...
          body: Container(
            child: ListView(padding: EdgeInsets.symmetric(horizontal: 15, vertical: 8), children: [
              ...
              ButtonClickAnimation(
                onTap: () {
                  Navigator.push(context, CupertinoPageRoute(builder: (context) => TextSizePageMobile()));
                },
                child: Row(
                  children: [
                    Expanded(
              ...
              ButtonClickAnimation(
                onTap: () {
                  Navigator.push(context, CupertinoPageRoute(builder: (context) => LanguagePageMobile()));
                },
                child: Row(
                  children: [
                    Expanded(
              ...
              ButtonClickAnimation(
                onTap: () {
                  Navigator.push(context, CupertinoPageRoute(builder: (context) => AutoPlayMediaMobile()));
                },
                child: Row(
                  children: [
                    Expanded(
              ...
              ButtonClickAnimation(
                onTap: () {
                  Navigator.push(context, CupertinoPageRoute(builder: (context) => StartupMediaPageMobile()));
                },
                child: Row(
                  children: [
                    Expanded(
