...
class TextSizePageMobile extends StatefulWidget {
  @override
  _TextSizePageStateMobile createState() => _TextSizePageStateMobile();
}

class _TextSizePageStateMobile extends State<TextSizePageMobile> {
