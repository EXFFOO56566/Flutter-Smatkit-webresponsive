...
import 'package:smartkit/FullApp/NewsApp/mobile/activity/Profile/EditNewsMobile.dart';
import 'package:smartkit/FullApp/NewsApp/model/Article.dart';

import '../MainActivityMobile.dart';
import '../CommentListMobile.dart';

class TextPostMobile extends StatefulWidget {
  @override
  _TextPostStateMobile createState() => _TextPostStateMobile();
}

class _TextPostStateMobile extends State<TextPostMobile> {
  List<Article> mypost;
                    ...
                    Padding(
                      ...
                      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                        ...
                        GestureDetector(
                            onTap: () {
                              selectednews = item;
                              Navigator.of(context).push(CupertinoPageRoute(builder: (context) => EditNewsMobile()));
                            },
                            child: Icon(
                              Icons.edit,
                              color: ColorsRes.grey.withOpacity(0.5),
