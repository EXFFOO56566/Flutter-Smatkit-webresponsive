...
class VideoPostMobile extends StatefulWidget {
  @override
  _VideoPostStateMobile createState() => _VideoPostStateMobile();
}

class _VideoPostStateMobile extends State<VideoPostMobile> {
  List<Article> mypost;
