...
class BookmarkPostMobile extends StatefulWidget {
  @override
  _BookmarkPostStateMobile createState() => _BookmarkPostStateMobile();
}

class _BookmarkPostStateMobile extends State<BookmarkPostMobile> {
  List<Article> mypost;
