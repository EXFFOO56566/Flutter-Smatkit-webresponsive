...
class EditNewsMobile extends StatefulWidget {
  @override
  _EditNewsStateMobile createState() => _EditNewsStateMobile();
}

class _EditNewsStateMobile extends State<EditNewsMobile> {
