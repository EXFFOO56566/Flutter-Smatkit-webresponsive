...
class AudioPostMobile extends StatefulWidget {
  @override
  _AudioPostStateMobile createState() => _AudioPostStateMobile();
}

class _AudioPostStateMobile extends State<AudioPostMobile> {
  List<Article> mypost;
