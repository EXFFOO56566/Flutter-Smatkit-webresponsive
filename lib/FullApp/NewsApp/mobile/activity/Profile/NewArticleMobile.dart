...
import 'package:smartkit/FullApp/NewsApp/mobile/helper/DashedBorder/dotted_border.dart';
...
class NewArticleMobile extends StatefulWidget {
  @override
  _NewArticleStateMobile createState() => _NewArticleStateMobile();
}

class _NewArticleStateMobile extends State<NewArticleMobile> {
