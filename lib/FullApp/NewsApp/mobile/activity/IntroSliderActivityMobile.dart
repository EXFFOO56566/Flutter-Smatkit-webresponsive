...
import 'package:smartkit/FullApp/NewsApp/mobile/activity/Login/LoginPageMobile.dart';

class IntroSliderActivityMobile extends StatefulWidget {
  @override
  IntroSliderStateMobile createState() => new IntroSliderStateMobile();
}

class IntroSliderStateMobile extends State<IntroSliderActivityMobile> {
            ...
            child: Align(
              ...
              child: Container(
                ...
                child: FloatingActionButton(
                  onPressed: () {
                    Navigator.of(context).pushReplacement(CupertinoPageRoute(builder: (context) => LoginPageMobile()));
                  },
