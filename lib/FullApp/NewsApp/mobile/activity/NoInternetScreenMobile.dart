...
class NoInternetScreenMobile extends StatefulWidget {
  @override
  _NoInternetScreenStateMobile createState() => _NoInternetScreenStateMobile();
}

class _NoInternetScreenStateMobile extends State<NoInternetScreenMobile> {
  @override
