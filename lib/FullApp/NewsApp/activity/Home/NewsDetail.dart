...
import 'package:smartkit/FullApp/NewsApp/activity/MainActivity.dart';
import 'package:smartkit/FullApp/NewsApp/activity/FullScreenImage.dart';
...
import 'package:smartkit/FullApp/NewsApp/activity/CommentList.dart';
...
class _NewsDetailState extends State<NewsDetail> {
  ...
  Widget imageWidget() {
    return ButtonClickAnimation(
        onTap: () {
          Navigator.of(context).push(CupertinoPageRoute(builder: (context) => FullScreenImage(selectednews.image)));
        },
        child: Card(
