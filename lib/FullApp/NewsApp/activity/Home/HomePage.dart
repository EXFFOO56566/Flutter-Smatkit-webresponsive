...
import 'package:smartkit/FullApp/NewsApp/activity/Home/NewsDetail.dart';
import 'package:smartkit/FullApp/NewsApp/activity/NotificationList.dart';
import 'package:smartkit/FullApp/NewsApp/activity/Profile/NewArticle.dart';
import 'package:smartkit/FullApp/NewsApp/activity/SearchPage.dart';
                  ...
                  return <Widget>[
                    SliverAppBar(
                      ...
                      leading: IconButton(
                        ...
                        onPressed: () {
                          Navigator.of(context).push(CupertinoPageRoute(builder: (context) => NewArticle()));
                        },
                      ),
                      ...
                      actions: <Widget>[
                        IconButton(
                            ...
                            onPressed: () {
                              Navigator.of(context).push(CupertinoPageRoute(builder: (context) => SearchPage()));
                            }),
                        IconButton(
      ...
      child: ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            ...
            return ButtonClickAnimation(
              onTap: () {
                selectednews = item;
                Navigator.of(context).push(CupertinoPageRoute(builder: (context) => NewsDetail()));
              },
              child: Container(
                width: 230,
                height: 220,
