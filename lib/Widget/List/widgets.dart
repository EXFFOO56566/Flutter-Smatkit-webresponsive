...
class SectionDetailView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (detail.title == null && detail.subtitle == null) {
      ...
      item = new ListTile(
        onTap: () {
          if (imageType == 'https://smartkit.wrteam.in/smartkit/images/google.jpg') {
            Navigator.of(context).push(new PageRouteBuilder(
                pageBuilder: (_, __, ___) => new Detail(
                      imagetype: "google",
                      url: detail.url,
                    )));
          } else if (imageType == 'https://smartkit.wrteam.in/smartkit/images/facebook.png') {
            Navigator.of(context).push(new PageRouteBuilder(
                pageBuilder: (_, __, ___) => new Detail(
                      imagetype: "fb",
                      url: detail.url,
                    )));
          } else if (imageType == 'https://smartkit.wrteam.in/smartkit/images/instagram.jpeg') {
            Navigator.of(context).push(new PageRouteBuilder(
                pageBuilder: (_, __, ___) => new Detail(
                      imagetype: "insta",
                      url: detail.url,
                    )));
          } else if (imageType == 'https://smartkit.wrteam.in/smartkit/images/twitter.jpg') {
            Navigator.of(context).push(new PageRouteBuilder(pageBuilder: (_, __, ___) => new Detail(imagetype: "twitter", url: detail.url)));
          }
        },
        title: new Text(
          detail.title,
