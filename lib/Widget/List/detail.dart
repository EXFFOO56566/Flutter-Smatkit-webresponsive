...
class _DetailPageState extends State<Detail> {
    ...
    return Align(
      ...
      child: new ElevatedButton(
        style: ElevatedButton.styleFrom(
          primary: const Color(0xFF6400df),
  ...
  void initState() {
    if (widget.imagetype == 'google') {
      ...
      } else if (widget.url == 'https://twitter.com/settings/your_twitter_data') {
        text = '\nDo you want to see your data that google has? you can download it in your mobile/computer, just go to the link and create an archive of the data.\n\n';
      }
      image = 'https://smartkit.wrteam.in/smartkit/images/google.jpg';
      ...
      image = 'https://smartkit.wrteam.in/smartkit/images/instagram.jpg';
      ...
      image = 'https://smartkit.wrteam.in/smartkit/images/twitter.jpg';
    } else if (widget.imagetype == 'lost') {
      image = 'https://smartkit.wrteam.in/smartkit/images/mob.jpeg';
      text =
      ...
      image = 'https://smartkit.wrteam.in/smartkit/images/click.jpeg';
      text =
    ...
    return new Scaffold(
      ...
      body: ListView(
        children: <Widget>[
          new Stack(
            children: <Widget>[
              new DetailBody(size: size, xOffset: 0, yOffset: 0, color: Colors.red),
              new Opacity(
                opacity: 0.9,
...
class DetailBody extends StatefulWidget {
  ...
  DetailBody({Key key, @required this.size, this.xOffset, this.yOffset, this.color}) : super(key: key);
  ...
  void initState() {
    ...
    animationController.addListener(() {
      ...
      for (int i = -2 - widget.xOffset; i <= widget.size.width.toInt() + 2; i++) {
        animList1.add(new Offset(i.toDouble() + widget.xOffset, sin((animationController.value * 360 - i) % 360 * Vector.degrees2Radians) * 20 + 50 + widget.yOffset));
      }
    });
