    ...
    return new Container(
      child: new Row(
        children: <Widget>[
          ...
          new Expanded(child: new Text(text, style: Theme.of(context).textTheme.subtitle1)),
        ],
      ),
      height: 56.0,
    );
      ...
      child: new FormField<T>(
        ...
        builder: (FormFieldState<T> field) {
          return new InputDecorator(
            ...
            child: _isEmpty(field) ? null : new Text(widget.formatter != null ? widget.formatter(field.value) : field.value.toString(), style: valueStyle),
          );
        },
      ),
    );
