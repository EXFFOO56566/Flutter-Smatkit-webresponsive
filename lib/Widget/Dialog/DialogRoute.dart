...
import 'Cupertino_dialoge.dart';
import 'Custom_Warning.dart';
import 'Detail_Dialog.dart';
import 'Rating_Dialog.dart';
import 'Single_Choice.dart';

class WrDialogRoute extends StatefulWidget {
  WrDialogRoute({Key key}) : super(key: key);

  @override
  _WrDialogRouteState createState() => _WrDialogRouteState();
}

class _WrDialogRouteState extends State<WrDialogRoute> {
  List wrNewComponents = [
    ...
    {
      'route': CupertinoDialog(),
      'title': "Cupertino Dialouge",
    },
    {
      'route': Single_Choice(),
      'title': "Single Choice",
