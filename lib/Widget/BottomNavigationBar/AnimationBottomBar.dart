...
class _FancyTabBarState extends State<FancyTabBar> with TickerProviderStateMixin {
  ...
  IconData nextIcon = Icons.person;
  ...
  void initState() {
    ...
    _fadeOutController = AnimationController(vsync: this, duration: Duration(milliseconds: (300 ~/ 5)));
    ...
    return Stack(
      ...
      children: <Widget>[
        Container(
          ...
          decoration: BoxDecoration(color: Colors.white, boxShadow: [BoxShadow(color: Colors.black12, offset: Offset(0, -1), blurRadius: 10)]),
          child: Row(
                  ...
                  children: <Widget>[
                    SizedBox(
                      ...
                      child: ClipRect(
                          ...
                          child: Container(
                            child: Center(
                              child: Container(width: 70, height: 70, decoration: BoxDecoration(color: Colors.white, shape: BoxShape.circle, boxShadow: [BoxShadow(color: Colors.black12, blurRadius: 10)])),
                            ),
                          )),
                    ),
                    SizedBox(
                    ...
                    SizedBox(
                      ...
                      width: 40,
                      child: Container(
                        decoration: BoxDecoration(shape: BoxShape.circle, color: PURPLE, border: Border.all(color: Colors.white, width: 5, style: BorderStyle.none)),
                        child: Padding(
