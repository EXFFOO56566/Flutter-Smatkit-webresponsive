...
class GalleryTwoColumn extends StatefulWidget {
  @override
  _GalleryTwoColumnState createState() => new _GalleryTwoColumnState();
}

class _GalleryTwoColumnState extends State<GalleryTwoColumn> {
  @override
